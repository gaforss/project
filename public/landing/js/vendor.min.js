...
! function(t, e) {
    ...
    const t = "transitionend",
        ...
        y = (t, e, n, r) => {
            const s = t.length;
            let i = t.indexOf(e);
            return -1 === i ? !n && r ? t[s - 1] : t[0] : (i += n ? 1 : -1, r && (i = (i + s) % s), t[Math.max(0, Math.min(i, s - 1))])
        },
        b = /[^.]*(?=\..*)\.|.*/,
        _ = /\..*/,
        w = /::\d+$/,
                ...
                return function r(s) {
                    ...
                    for (let {
                        ...
                        for (const o of i)
                            if (o === a) return I(s, {
                                delegateTarget: a
                            }), r.oneOff && D.off(t, s.type, e, n), n.apply(a, [s])
                }
            }(t, n, a) : function(t, e) {
                return function n(r) {
                    return I(r, {
                        delegateTarget: t
                    }), n.oneOff && D.off(t, r.type, e), e.apply(t, [r])
                }
            }(t, a);
        d.delegationSelector = i ? n : null, d.callable = a, d.oneOff = s, d.uidEvent = p, c[p] = d, t.addEventListener(o, d, i)
    }
    ...
    const D = {
        ...
        off(t, e, n, r) {
            if ("string" != typeof e || !t) return;
            const [s, i, a] = M(e, n, r), o = a !== e, l = T(t), c = l[a] || {}, u = e.startsWith(".");
            if (void 0 === i) {
                if (u)
                    for (const n of Object.keys(l)) j(t, l, n, e.slice(1));
        ...
        trigger(t, e, n) {
            ...
            let s = null,
                ...
                a = !0,
                o = !1;
            e !== $(e) && r && (s = r.Event(e, n), r(t).trigger(s), i = !s.isPropagationStopped(), a = !s.isImmediatePropagationStopped(), o = s.isDefaultPrevented());
            let l = new Event(e, {
                bubbles: i,
                cancelable: !0
            });
            return l = I(l, n), o && l.preventDefault(), a && t.dispatchEvent(l), l.defaultPrevented && s && s.preventDefault(), l
        }
    };
    ...
    const R = {
        ...
        getDataAttributes(t) {
            ...
            for (const r of n) {
                let n = r.replace(/^bs/, "");
                n = n.charAt(0).toLowerCase() + n.slice(1, n.length), e[n] = N(t.dataset[r])
            }
            return e
        },
    ...
    class z {
        ...
        _typeCheckConfig(t, e = this.constructor.DefaultType) {
            for (const r of Object.keys(e)) {
                const s = e[r],
                    a = t[r],
                    o = i(a) ? "element" : null == (n = a) ? `${n}` : Object.prototype.toString.call(n).match(/\s([a-z]+)/i)[1].toLowerCase();
                if (!new RegExp(s).test(o)) throw new TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${r}" provided type "${o}" but expected type "${s}".`)
            }
            var n
        }
    }
    class q extends z {
        constructor(t, e) {
            super(), (t = a(t)) && (this._element = t, this._config = this._getConfig(e), V.set(this._element, this.constructor.DATA_KEY, this))
        }
        dispose() {
            V.remove(this._element, this.constructor.DATA_KEY), D.off(this._element, this.constructor.EVENT_KEY);
    ...
    class ot extends q {
        constructor(t, e) {
            super(t, e), this._interval = null, this._activeElement = null, this._isSliding = !1, this.touchTimeout = null, this._swipeHelper = null, this._indicatorsElement = G.findOne(".carousel-indicators", this._element), this._addEventListeners(), this._config.ride === nt && this.cycle()
        }
        static get Default() {
            return it
        }
        ...
        _maybeEnableCycle() {
            this._config.ride && (this._isSliding ? D.one(this._element, et, (() => this.cycle())) : this.cycle())
        }
        to(t) {
            const e = this._getItems();
            if (t > e.length - 1 || t < 0) return;
            if (this._isSliding) return void D.one(this._element, et, (() => this.to(t)));
        ...
        _addEventListeners() {
            this._config.keyboard && D.on(this._element, "keydown.bs.carousel", (t => this._keydown(t))), "hover" === this._config.pause && (D.on(this._element, "mouseenter.bs.carousel", (() => this.pause())), D.on(this._element, "mouseleave.bs.carousel", (() => this._maybeEnableCycle()))), this._config.touch && K.isSupported() && this._addTouchEventListeners()
        }
        _addTouchEventListeners() {
            for (const t of G.find(".carousel-item img", this._element)) D.on(t, "dragstart.bs.carousel", (t => t.preventDefault()));
            const t = {
        ...
        _slide(t, e = null) {
            ...
            s.classList.add(c), p(s), n.classList.add(l), s.classList.add(l), this._queueCallback((() => {
                s.classList.remove(l, c), s.classList.add(rt), n.classList.remove(rt, c, l), this._isSliding = !1, a(et)
    ...
    D.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", (function(t) {
        const e = r(this);
        if (!e || !e.classList.contains(nt)) return;
        t.preventDefault();
        const n = ot.getOrCreateInstance(e),
            s = this.getAttribute("data-bs-slide-to");
        return s ? (n.to(s), void n._maybeEnableCycle()) : "next" === R.getDataAttribute(this, "slide") ? (n.next(), void n._maybeEnableCycle()) : (n.prev(), void n._maybeEnableCycle())
    ...
    class ht extends q {
        ...
        show() {
            ...
            let t = [];
            if (this._config.parent && (t = this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter((t => t !== this._element)).map((t => ht.getOrCreateInstance(t, {
                    toggle: !1
            ...
            this._queueCallback((() => {
                this._isTransitioning = !1, this._element.classList.remove(ut), this._element.classList.add(ct, lt), this._element.style[e] = "", D.trigger(this._element, "shown.bs.collapse")
        ...
        hide() {
            ...
            this._element.style[t] = `${this._element.getBoundingClientRect()[t]}px`, p(this._element), this._element.classList.add(ut), this._element.classList.remove(ct, lt);
            for (const t of this._triggerArray) {
                const e = r(t);
                e && !this._isShown(e) && this._addAriaAndCollapsedClass([t], !1)
            }
            this._isTransitioning = !0, this._element.style[t] = "", this._queueCallback((() => {
                this._isTransitioning = !1, this._element.classList.remove(ut), this._element.classList.add(ct), D.trigger(this._element, "hidden.bs.collapse")
            }), this._element, !0)
        }
    ...
    D.on(document, "click.bs.collapse.data-api", pt, (function(t) {
        ...
        const e = n(this),
            r = G.find(e);
        for (const t of r) ht.getOrCreateInstance(t, {
            toggle: !1
        }).toggle()
    })), m(ht);
    var mt = "top",
        ...
        fn: function(t) {
            ...
            Object.keys(e.elements).forEach((function(t) {
                var n = e.styles[t] || {},
                    r = e.attributes[t] || {},
                    s = e.elements[t];
                qt(s) && Ht(s) && (Object.assign(s.style, n), Object.keys(r).forEach((function(t) {
                    var e = r[t];
            ...
            return Object.assign(e.elements.popper.style, n.popper), e.styles = n, e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow),
                function() {
                    Object.keys(e.elements).forEach((function(t) {
                        ...
                        qt(r) && Ht(r) && (Object.assign(r.style, i), Object.keys(s).forEach((function(t) {
                            r.removeAttribute(t)
                        })))
                    }))
                }
    ...
    function Qt(t, e, n) {
        ...
        var r = t.getBoundingClientRect(),
            s = 1,
            i = 1;
        e && qt(t) && (s = t.offsetWidth > 0 && Yt(r.width) / t.offsetWidth || 1, i = t.offsetHeight > 0 && Yt(r.height) / t.offsetHeight || 1);
    ...
    function re(t) {
        return "html" === Ht(t) ? t : t.assignedSlot || t.parentNode || (Bt(t) ? t.host : null) || ne(t)
    }
    ...
    function ie(t) {
        for (var e = Rt(t), n = se(t); n && ee(n) && "static" === te(n).position;) n = se(n);
        return n && ("html" === Ht(n) || "body" === Ht(n) && "static" === te(n).position) ? e : n || function(t) {
            var e = /firefox/i.test(Xt());
            if (/Trident/i.test(Xt()) && qt(t) && "fixed" === te(t).position) return null;
            var n = re(t);
            for (Bt(n) && (n = n.host); qt(n) && ["html", "body"].indexOf(Ht(n)) < 0;) {
                var r = te(n);
    ...
    const ue = {
        ...
        effect: function(t) {
            ...
            null != r && ("string" != typeof r || (r = e.elements.popper.querySelector(r))) && Zt(e.elements.popper, r) && (e.elements.arrow = r)
        },
    ...
    function fe(t) {
        ...
        if (c) {
            var S = ie(n),
                C = "clientHeight",
                x = "clientWidth";
            S === Rt(n) && "static" !== te(S = ne(n)).position && "absolute" === o && (C = "scrollHeight", x = "scrollWidth"), (s === mt || (s === yt || s === vt) && i === St) && (_ = gt, m -= (p && S === w && w.visualViewport ? w.visualViewport.height : S[C]) - r.height, m *= l ? 1 : -1), s !== yt && (s !== mt && s !== gt || i !== St) || (b = vt, f -= (p && S === w && w.visualViewport ? w.visualViewport.width : S[x]) - r.width, f *= l ? 1 : -1)
        }
        ...
        return f = T.x, m = T.y, l ? Object.assign({}, E, ((k = {})[_] = y ? "0" : "", k[b] = v ? "0" : "", k.transform = (w.devicePixelRatio || 1) <= 1 ? "translate(" + f + "px, " + m + "px)" : "translate3d(" + f + "px, " + m + "px, 0)", k)) : Object.assign({}, E, ((e = {})[_] = y ? m + "px" : "", e[b] = v ? f + "px" : "", e.transform = "", e))
    }
    const he = {
        name: "computeStyles",
        enabled: !0,
    ...
    function xe(t) {
        return ["html", "body", "#document"].indexOf(Ht(t)) >= 0 ? t.ownerDocument.body : qt(t) && Ce(t) ? t : xe(re(t))
    }
    ...
    function Te(t, e, n) {
        return e === xt ? Ee(function(t, e) {
            ...
            var e, n = ne(t),
                ...
                i = Ut(n.scrollWidth, n.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0),
                a = Ut(n.scrollHeight, n.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0),
                o = -r.scrollLeft + Se(t),
                l = -r.scrollTop;
            return "rtl" === te(s || n).direction && (o += Ut(n.clientWidth, s ? s.clientWidth : 0) - i), {
                width: i,
                height: a,
                x: o,
                y: l
        ...
        var n = e,
            ...
            w = function(t, e, n, r) {
                var s = "clippingParents" === e ? function(t) {
                        var e = ke(re(t)),
                            n = ["absolute", "fixed"].indexOf(te(t).position) >= 0 && qt(t) ? ie(t) : t;
                        return zt(n) ? e.filter((function(t) {
                    ...
                    o = i.reduce((function(e, n) {
                        var s = Te(t, n, r);
                        return e.top = Ut(s.top, e.top), e.right = Gt(s.right, e.right), e.bottom = Gt(s.bottom, e.bottom), e.left = Ut(s.left, e.left), e
                    }), Te(t, a, r));
    ...
    const Oe = {
        ...
        fn: function(t) {
            ...
            if (!e.modifiersData[r]._skip) {
                for (var s = n.mainAxis, i = void 0 === s || s, a = n.altAxis, o = void 0 === a || a, l = n.fallbackPlacements, c = n.padding, u = n.boundary, p = n.rootBoundary, d = n.altBoundary, f = n.flipVariations, h = void 0 === f || f, m = n.allowedAutoPlacements, g = e.options.placement, v = Wt(g), y = l || (v !== g && h ? function(t) {
                        if (Wt(t) === bt) return [];
                        var e = ye(t);
                        return [_e(t), e, _e(e)]
                    }(g) : [ye(g)]), b = [g].concat(y).reduce((function(t, n) {
                        return t.concat(Wt(n) === bt ? function(t, e) {
                            void 0 === e && (e = {});
                            var n = e,
                                r = n.placement,
                                s = n.boundary,
                    ...
                    }), []), _ = e.rects.reference, w = e.rects.popper, S = new Map, C = !0, x = b[0], k = 0; k < b.length; k++) {
                    var E = b[k],
                        T = Wt(E),
                        P = pe(E) === wt,
                        M = [mt, gt].indexOf(T) >= 0,
                    ...
                    var $ = ye(j),
                        D = [];
                    if (i && D.push(A[T] <= 0), o && D.push(A[j] <= 0, A[$] <= 0), D.every((function(t) {
                            return t
                        }))) {
                        x = E, C = !1;
                        break
        ...
        Le = {
            ...
            fn: function(t) {
                var e = t.state,
                    ...
                    C = e.rects.reference,
                    x = e.rects.popper,
                    k = "function" == typeof m ? m(Object.assign({}, e.rects, {
                        placement: e.placement
                    })) : m,
                    E = "number" == typeof k ? {
                        mainAxis: k,
                ...
                if (S) {
                    if (i) {
                        var M, O = "y" === _ ? mt : yt,
                            ...
                            B = z[A],
                            F = oe(0, C[j], R[j]),
                            W = b ? C[j] / 2 - L - F - q - E.mainAxis : V - F - q - E.mainAxis,
                            U = b ? -C[j] / 2 + L + F + B + E.mainAxis : N + F + B + E.mainAxis,
                    ...
                    if (o) {
                        var J, Z = "x" === _ ? mt : yt,
                            ...
                            ct = f && it ? function(t, e, n) {
                                var r = oe(t, e, n);
                                return r > n ? n : r
                            }(ot, et, lt) : oe(f ? ot : rt, et, f ? lt : st);
                        S[w] = ct, P[w] = ct - et
                    }
                    e.modifiersData[r] = P
                }
    ...
    function Ve(t, e, n) {
        ...
        return (i || !i && !n) && (("body" !== Ht(e) || Ce(o)) && (c = (r = e) !== Rt(r) && qt(r) ? {
            scrollLeft: (s = r).scrollLeft,
            scrollTop: s.scrollTop
        } : we(r)), qt(e) ? ((u = Qt(e, !0)).x += e.clientLeft, u.y += e.clientTop) : o && (u.x = Se(o))), {
                ...
                u = {
                    ...
                    setOptions: function(n) {
                        ...
                        p(), o.options = Object.assign({}, i, o.options, s), o.scrollParents = {
                            reference: zt(t) ? ke(t) : t.contextElement ? ke(t.contextElement) : [],
                            popper: ke(e)
                        };
    ...
    var qe = ze(),
        Be = ze({
            defaultModifiers: [ge, Ie, he, Ft]
        }),
        Fe = ze({
            defaultModifiers: [ge, Ie, he, Ft, De, Oe, Le, ue, $e]
        });
    ...
    class un extends q {
        constructor(t, e) {
            super(t, e), this._popper = null, this._parent = this._element.parentNode, this._menu = G.next(this._element, tn)[0] || G.prev(this._element, tn)[0] || G.findOne(tn, this._parent), this._inNavbar = this._detectNavbar()
        }
        static get Default() {
            return ln
        }
        ...
        show() {
            ...
            if (!D.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav"))
                    for (const t of [].concat(...document.body.children)) D.on(t, "mouseover", u);
                this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(Qe), this._element.classList.add(Qe), D.trigger(this._element, "shown.bs.dropdown", t)
            }
        }
        hide() {
            if (l(this._element) || !this._isShown()) return;
        ...
        _completeHide(t) {
            if (!D.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented) {
                if ("ontouchstart" in document.documentElement)
                    for (const t of [].concat(...document.body.children)) D.off(t, "mouseover", u);
                this._popper && this._popper.destroy(), this._menu.classList.remove(Qe), this._element.classList.remove(Qe), this._element.setAttribute("aria-expanded", "false"), R.removeDataAttribute(this._menu, "popper"), D.trigger(this._element, "hidden.bs.dropdown", t)
            }
        }
        _getConfig(t) {
            if ("object" == typeof(t = super._getConfig(t)).reference && !i(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError(`${Ue.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
            return t
        }
        _createPopper() {
            if (void 0 === We) throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");
            let t = this._element;
            "parent" === this._config.reference ? t = this._parent : i(this._config.reference) ? t = a(this._config.reference) : "object" == typeof this._config.reference && (t = this._config.reference);
        ...
        _selectMenuItem({
            ...
            const n = G.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter((t => o(t)));
        ...
        static clearMenus(t) {
            ...
            for (const n of e) {
                ...
                if (r.includes(e._element) || "inside" === e._config.autoClose && !s || "outside" === e._config.autoClose && s) continue;
        ...
        static dataApiKeydownHandler(t) {
            ...
            if (e && !n) return;
            t.preventDefault();
            const s = this.matches(Je) ? this : G.prev(this, Je)[0] || G.next(this, Je)[0] || G.findOne(Je, t.delegateTarget.parentNode),
    ...
    D.on(document, Ke, Je, un.dataApiKeydownHandler), D.on(document, Ke, tn, un.dataApiKeydownHandler), D.on(document, Xe, un.clearMenus), D.on(document, "keyup.bs.dropdown.data-api", un.clearMenus), D.on(document, Xe, Je, (function(t) {
    ...
    class mn {
        ...
        hide() {
            ...
            this._disableOverFlow(), this._setElementAttributes(this._element, fn, (e => e + t)), this._setElementAttributes(pn, fn, (e => e + t)), this._setElementAttributes(dn, hn, (e => e - t))
        }
        reset() {
            this._resetElementAttributes(this._element, "overflow"), this._resetElementAttributes(this._element, fn), this._resetElementAttributes(pn, fn), this._resetElementAttributes(dn, hn)
        }
        isOverflowing() {
        ...
        _resetElementAttributes(t, e) {
            this._applyManipulationCallback(t, (t => {
                ...
                null !== n ? (R.removeDataAttribute(t, e), t.style.setProperty(e, n)) : t.style.removeProperty(e)
            }))
        }
        _applyManipulationCallback(t, e) {
            if (i(t)) e(t);
            else
                for (const n of G.find(t, this._element)) e(n)
        }
    }
    const gn = "show",
    ...
    class _n extends z {
        ...
        show(t) {
            ...
            this._config.isAnimated && p(e), e.classList.add(gn), this._emulateAnimation((() => {
                g(t)
            }))
        }
        hide(t) {
        ...
        dispose() {
            this._isAppended && (D.off(this._element, vn), this._element.remove(), this._isAppended = !1)
        }
        _getElement() {
            if (!this._element) {
        ...
        _append() {
            ...
            this._config.rootElement.append(t), D.on(t, vn, (() => {
    ...
    class kn extends z {
        ...
        activate() {
            this._isActive || (this._config.autofocus && this._config.trapElement.focus(), D.off(document, wn), D.on(document, "focusin.bs.focustrap", (t => this._handleFocusin(t))), D.on(document, "keydown.tab.bs.focustrap", (t => this._handleKeydown(t))), this._isActive = !0)
        }
        deactivate() {
        ...
        _handleFocusin(t) {
            ...
            0 === n.length ? e.focus() : this._lastTabNavDirection === Sn ? n[n.length - 1].focus() : n[0].focus()
        }
        _handleKeydown(t) {
    ...
    class $n extends q {
        constructor(t, e) {
            super(t, e), this._dialog = G.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._isTransitioning = !1, this._scrollBar = new mn, this._addEventListeners()
        }
        static get Default() {
            return An
        }
        ...
        show(t) {
            this._isShown || this._isTransitioning || D.trigger(this._element, Tn, {
                relatedTarget: t
        ...
        hide() {
            this._isShown && !this._isTransitioning && (D.trigger(this._element, "hide.bs.modal").defaultPrevented || (this._isShown = !1, this._isTransitioning = !0, this._focustrap.deactivate(), this._element.classList.remove(Mn), this._queueCallback((() => this._hideModal()), this._element, this._isAnimated())))
        }
        dispose() {
        ...
        _showElement(t) {
            ...
            e && (e.scrollTop = 0), p(this._element), this._element.classList.add(Mn), this._queueCallback((() => {
        ...
        _hideModal() {
            this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide((() => {
                document.body.classList.remove(Pn), this._resetAdjustments(), this._scrollBar.reset(), D.trigger(this._element, En)
            }))
        }
        _isAnimated() {
    ...
    D.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(t) {
        const e = r(this);
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(), D.one(e, Tn, (t => {
            t.defaultPrevented || D.one(e, En, (() => {
                o(this) && this.focus()
            }))
        }));
    ...
    class qn extends q {
        ...
        show(t) {
            this._isShown || D.trigger(this._element, "show.bs.offcanvas", {
                relatedTarget: t
            }).defaultPrevented || (this._isShown = !0, this._backdrop.show(), this._config.scroll || (new mn).hide(), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(In), this._queueCallback((() => {
                this._config.scroll && !this._config.backdrop || this._focustrap.activate(), this._element.classList.add(Dn), this._element.classList.remove(In), D.trigger(this._element, "shown.bs.offcanvas", {
                    relatedTarget: t
                })
            }), this._element, !0))
        }
        hide() {
            this._isShown && (D.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.add(Ln), this._backdrop.hide(), this._queueCallback((() => {
                this._element.classList.remove(Dn, Ln), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._config.scroll || (new mn).reset(), D.trigger(this._element, Hn)
            }), this._element, !0)))
        }
        dispose() {
            this._backdrop.dispose(), this._focustrap.deactivate(), super.dispose()
        ...
        _initializeBackDrop() {
            ...
            return new _n({
                ...
                clickCallback: t ? () => {
                    "static" !== this._config.backdrop ? this.hide() : D.trigger(this._element, Nn)
                } : null
            })
        }
        _initializeFocusTrap() {
        ...
        _addEventListeners() {
            D.on(this._element, "keydown.dismiss.bs.offcanvas", (t => {
                "Escape" === t.key && (this._config.keyboard ? this.hide() : D.trigger(this._element, Nn))
            }))
        }
        static jQueryInterface(t) {
            return this.each((function() {
    ...
    D.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function(t) {
        ...
        for (const t of G.find("[aria-modal][class*=show][class*=offcanvas-]")) "fixed" !== getComputedStyle(t).position && qn.getOrCreateInstance(t).hide()
    })), B(qn), m(qn);
    const Bn = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
        ...
        Un = (t, e) => {
            ...
            return e.includes(n) ? !Bn.has(n) || Boolean(Fn.test(t.nodeValue) || Wn.test(t.nodeValue)) : e.filter((t => t instanceof RegExp)).some((t => t.test(n)))
        },
        Gn = {
    ...
    class Qn extends z {
        ...
        _setContent(t, e, n) {
            ...
            r && ((e = this._resolvePossibleFunction(e)) ? i(e) ? this._putElementInTemplate(a(e), r) : this._config.html ? r.innerHTML = this._maybeSanitize(e) : r.textContent = e : r.remove())
        }
        _maybeSanitize(t) {
    ...
    class lr extends q {
        constructor(t, e) {
            if (void 0 === We) throw new TypeError("Bootstrap's tooltips require Popper (https://popper.js.org)");
        ...
        dispose() {
            clearTimeout(this._timeout), D.off(this._element.closest(er), nr, this._hideModalHandler), this.tip && this.tip.remove(), this._element.getAttribute("data-bs-original-title") && this._element.setAttribute("title", this._element.getAttribute("data-bs-original-title")), this._disposePopper(), super.dispose()
        }
        show() {
            ...
            if (this._element.ownerDocument.documentElement.contains(this.tip) || (r.append(n), D.trigger(this._element, this.constructor.eventName("inserted"))), this._popper ? this._popper.update() : this._popper = this._createPopper(n), n.classList.add(tr), "ontouchstart" in document.documentElement)
                for (const t of [].concat(...document.body.children)) D.on(t, "mouseover", u);
            this._queueCallback((() => {
        ...
        hide() {
            ...
            if (D.trigger(this._element, this.constructor.eventName("hide")).defaultPrevented) return;
            const t = this._getTipElement();
            if (t.classList.remove(tr), "ontouchstart" in document.documentElement)
                for (const t of [].concat(...document.body.children)) D.off(t, "mouseover", u);
            this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1, this._isHovered = null, this._queueCallback((() => {
                this._isWithActiveTrigger() || (this._isHovered || t.remove(), this._element.removeAttribute("aria-describedby"), D.trigger(this._element, this.constructor.eventName("hidden")), this._disposePopper())
            }), this.tip, this._isAnimated())
        }
        update() {
        ...
        _createTipElement(t) {
            ...
            if (!e) return null;
            e.classList.remove(Zn, tr), e.classList.add(`bs-${this.constructor.NAME}-auto`);
            const n = (t => {
                do {
            ...
            return e.setAttribute("id", n), this._isAnimated() && e.classList.add(Zn), e
        }
        setContent(t) {
            this._newContent = t, this._isShown() && (this._disposePopper(), this.show())
        }
        _getTemplateFactory(t) {
            return this._templateFactory ? this._templateFactory.changeContent(t) : this._templateFactory = new Qn({
                ...this._config,
                content: t,
        ...
        _setListeners() {
            ...
            for (const e of t)
                if ("click" === e) D.on(this._element, this.constructor.eventName("click"), this._config.selector, (t => {
                ...
                D.on(this._element, t, this._config.selector, (t => {
                    ...
                    const e = this._initializeOnDelegatedTarget(t);
                    e._activeTrigger["focusout" === t.type ? sr : rr] = e._element.contains(t.relatedTarget), e._leave()
                }))
            }
    ...
    class vr extends q {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (D.off(this._config.target, dr), D.on(this._config.target, dr, hr, (t => {
        ...
        _observerCallback(t) {
            ...
            for (const i of t) {
                ...
                const t = i.target.offsetTop >= this._previousScrollData.visibleEntryTop;
                if (s && t) {
                    if (n(i), !r) return
                } else s || t || n(i)
            }
        ...
        _process(t) {
            this._activeTarget !== t && (this._clearActiveClass(this._config.target), this._activeTarget = t, t.classList.add(fr), this._activateParents(t), D.trigger(this._element, "activate.bs.scrollspy", {
                relatedTarget: t
            }))
        }
        _activateParents(t) {
            if (t.classList.contains("dropdown-item")) G.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(fr);
            else
                for (const e of G.parents(t, ".nav, .list-group"))
                    for (const t of G.prev(e, ".nav-link, .nav-item > .nav-link, .list-group-item")) t.classList.add(fr)
        }
        _clearActiveClass(t) {
    ...
    class Tr extends q {
        constructor(t) {
            super(t), this._parent = this._element.closest('.list-group, .nav, [role="tablist"]'), this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), D.on(this._element, "keydown.bs.tab", (t => this._keydown(t))))
        }
        static get NAME() {
            return "tab"
        }
        show() {
            ...
            const e = this._getActiveElem(),
                n = e ? D.trigger(e, "hide.bs.tab", {
                    relatedTarget: t
                }) : null;
            D.trigger(t, "show.bs.tab", {
                relatedTarget: e
            }).defaultPrevented || n && n.defaultPrevented || (this._deactivate(e, t), this._activate(t, e))
        }
        _activate(t, e) {
            t && (t.classList.add(Sr), this._activate(r(t)), this._queueCallback((() => {
                "tab" === t.getAttribute("role") ? (t.removeAttribute("tabindex"), t.setAttribute("aria-selected", !0), this._toggleDropDown(t, !0), D.trigger(t, "shown.bs.tab", {
                    relatedTarget: e
                })) : t.classList.add(xr)
            }), t, t.classList.contains(Cr)))
        }
        _deactivate(t, e) {
            t && (t.classList.remove(Sr), t.blur(), this._deactivate(r(t)), this._queueCallback((() => {
                "tab" === t.getAttribute("role") ? (t.setAttribute("aria-selected", !1), t.setAttribute("tabindex", "-1"), this._toggleDropDown(t, !1), D.trigger(t, "hidden.bs.tab", {
                    relatedTarget: e
        ...
        _keydown(t) {
            ...
            const e = [br, wr].includes(t.key),
                n = y(this._getChildren().filter((t => !l(t))), t.target, e, !0);
            n && (n.focus({
                preventScroll: !0
            }), Tr.getOrCreateInstance(n).show())
        }
        _getChildren() {
        ...
        _toggleDropDown(t, e) {
            ...
            r(".dropdown-toggle", Sr), r(".dropdown-menu", xr), n.setAttribute("aria-expanded", e)
        }
    ...
    D.on(document, "click.bs.tab", kr, (function(t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(), l(this) || Tr.getOrCreateInstance(this).show()
    })), D.on(window, "load.bs.tab", (() => {
        for (const t of G.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]')) Tr.getOrCreateInstance(t)
    })), m(Tr);
    const Pr = "hide",
        Mr = "show",
        Or = "showing",
    ...
    class $r extends q {
        ...
        show() {
            D.trigger(this._element, "show.bs.toast").defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), this._element.classList.remove(Pr), p(this._element), this._element.classList.add(Mr, Or), this._queueCallback((() => {
                this._element.classList.remove(Or), D.trigger(this._element, "shown.bs.toast"), this._maybeScheduleHide()
            }), this._element, this._config.animation))
        }
        hide() {
            this.isShown() && (D.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.add(Or), this._queueCallback((() => {
                this._element.classList.add(Pr), this._element.classList.remove(Or, Mr), D.trigger(this._element, "hidden.bs.toast")
            }), this._element, this._config.animation)))
        }
        dispose() {
            this._clearTimeout(), this.isShown() && this._element.classList.remove(Mr), super.dispose()
        }
        isShown() {
        ...
        _setListeners() {
            D.on(this._element, "mouseover.bs.toast", (t => this._onInteraction(t, !0))), D.on(this._element, "mouseout.bs.toast", (t => this._onInteraction(t, !1))), D.on(this._element, "focusin.bs.toast", (t => this._onInteraction(t, !0))), D.on(this._element, "focusout.bs.toast", (t => this._onInteraction(t, !1)))
        }
        _clearTimeout() {
...
function(t, e) {
    ...
    function e(n, r) {
        void 0 === n && (n = {}), void 0 === r && (r = {}), Object.keys(r).forEach((s => {
    ...
    const u = {
        ...
        hasClass: function() {
            for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
            const r = o(e.map((t => t.split(" "))));
            return l(this, (t => r.filter((e => t.classList.contains(e))).length > 0)).length > 0
        },
        ...
        on: function() {
            ...
            function o(t) {
                ...
                if (n.indexOf(t) < 0 && n.unshift(t), c(e).is(s)) i.apply(e, n);
                    ...
                    const t = c(e).parents();
                    for (let e = 0; e < t.length; e += 1) c(t[e]).is(s) && i.apply(t[e], n)
                }
            }
            ...
            "function" == typeof e[1] && ([r, i, a] = e, s = void 0), a || (a = !1);
            const u = r.split(" ");
            let p;
                ...
                for (let t = 0; t < this.length; t += 1) {
                    ...
                    if (!s && n.dom7Listeners ? r = n.dom7Listeners[e] : s && n.dom7LiveListeners && (r = n.dom7LiveListeners[e]), r && r.length)
                        for (let t = r.length - 1; t >= 0; t -= 1) {
                            const s = r[t];
                            i && s.listener === i || i && s.listener && s.listener.dom7proxy && s.listener.dom7proxy === i ? (n.removeEventListener(e, s.proxyListener, a), r.splice(t, 1)) : i || (n.removeEventListener(e, s.proxyListener, a), r.splice(t, 1))
                        }
                }
            }
            return this
            ...
            for (let e = 0; e < s.length; e += 1) {
                ...
                for (let e = 0; e < this.length; e += 1) {
                    ...
                    if (t.CustomEvent) {
                        ...
                        s.dom7EventData = n.filter(((t, e) => e > 0)), s.dispatchEvent(e), s.dom7EventData = [], delete s.dom7EventData
                    }
                }
            }
            return this
        ...
        for (let n = 1; n < arguments.length; n += 1) {
            ...
            if (null != r && !m(r)) {
                ...
                for (let e = 0, s = n.length; e < s; e += 1) {
                    ...
                    void 0 !== i && i.enumerable && (h(t[s]) && h(r[s]) ? r[s].__swiper__ ? t[s] = r[s] : g(t[s], r[s]) : !h(t[s]) && h(r[s]) ? (t[s] = {}, r[s].__swiper__ ? t[s] = r[s] : g(t[s], r[s])) : t[s] = r[s])
                }
            }
        }
        return t
    ...
    function y(t) {
        ...
        const u = n > a ? "next" : "prev",
            ...
            d = () => {
                ...
                let u = a + i * (n - a);
                if (p(u, n) && (u = n), e.wrapperEl.scrollTo({
                        [r]: u
                    }), p(u, n)) return e.wrapperEl.style.overflow = "hidden", e.wrapperEl.style.scrollSnapType = "", setTimeout((() => {
    ...
    function C(t) {
        return void 0 === t && (t = {}), _ || (_ = function(t) {
            ...
            const d = a.match(/(iPod)(.*OS\s([\d_]+))?/),
                ...
                h = "Win32" === s;
            let m = "MacIntel" === s;
            return !p && m && n.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${c}`) >= 0 && (p = a.match(/(Version)\/([\d.]+)/), p || (p = [0, 1, "13_0_0"]), m = !1), u && !h && (o.os = "android", o.android = !0), (p || f || d) && (o.os = "ios", o.ios = !0), o
        }(t)), _
    }
    ...
    var k = {
            ...
            emit() {
                ...
                return "string" == typeof i[0] || Array.isArray(i[0]) ? (e = i[0], n = i.slice(1, i.length), r = t) : (e = i[0].events, n = i[0].data, r = i[0].context || t), n.unshift(r), (Array.isArray(e) ? e : e.split(" ")).forEach((e => {
        ...
        E = {
            ...
            updateSlides: function() {
                ...
                "string" == typeof _ && _.indexOf("%") >= 0 && (_ = parseFloat(_.replace("%", "")) / 100 * i), t.virtualSize = -_, a ? u.css({
                    ...
                    marginBottom: "",
                    marginTop: ""
                }), r.centeredSlides && r.cssMode && (v(t.wrapperEl, "--swiper-centered-offset-before", ""), v(t.wrapperEl, "--swiper-centered-offset-after", ""));
                ...
                for (let s = 0; s < p; s += 1) {
                    ...
                    if (x && t.grid.updateSlide(s, a, p, e), "none" !== a.css("display")) {
                        if ("auto" === r.slidesPerView) {
                            ...
                            if (o && (a[0].style.transform = "none"), l && (a[0].style.webkitTransform = "none"), r.roundLengths) k = t.isHorizontal() ? a.outerWidth(!0) : a.outerHeight(!0);
                            else {
                                const t = n(i, "width"),
                                    e = n(i, "padding-left"),
                                    r = n(i, "padding-right"),
                            ...
                            o && (a[0].style.transform = o), l && (a[0].style.webkitTransform = l), r.roundLengths && (k = Math.floor(k))
                        } else k = (i - (r.slidesPerView - 1) * _) / r.slidesPerView, r.roundLengths && (k = Math.floor(k)), u[s] && (u[s].style[e("width")] = `${k}px`);
                        u[s] && (u[s].swiperSlideSize = k), h.push(k), r.centeredSlides ? (w = w + k / 2 + S / 2 + _, 0 === S && 0 !== s && (w = w - i / 2 - _), 0 === s && (w = w - i / 2 - _), Math.abs(w) < .001 && (w = 0), r.roundLengths && (w = Math.floor(w)), C % r.slidesPerGroup == 0 && d.push(w), f.push(w)) : (r.roundLengths && (w = Math.floor(w)), (C - Math.min(t.params.slidesPerGroupSkip, C)) % t.params.slidesPerGroup == 0 && d.push(w), f.push(w), w = w + k + _), t.virtualSize += k + _, S = k, C += 1
                    }
                }
                if (t.virtualSize = Math.max(t.virtualSize, i) + g, a && o && ("slide" === r.effect || "coverflow" === r.effect) && s.css({
                        width: `${t.virtualSize+r.spaceBetween}px`
                    }), r.setWrapperSize && s.css({
                        [e("width")]: `${t.virtualSize+r.spaceBetween}px`
                    }), x && t.grid.updateWrapperSize(k, d, e), !r.centeredSlides) {
                    const e = [];
                ...
                if (Object.assign(t, {
                    ...
                    v(t.wrapperEl, "--swiper-centered-offset-before", -d[0] + "px"), v(t.wrapperEl, "--swiper-centered-offset-after", t.size / 2 - h[h.length - 1] / 2 + "px");
                    const e = -t.snapGrid[0],
                        n = -t.slidesGrid[0];
                    t.snapGrid = t.snapGrid.map((t => t + e)), t.slidesGrid = t.slidesGrid.map((t => t + n))
                }
                if (p !== c && t.emit("slidesLengthChange"), d.length !== y && (t.params.watchOverflow && t.checkOverflow(), t.emit("snapGridLengthChange")), f.length !== b && t.emit("slidesGridLengthChange"), r.watchSlidesProgress && t.updateSlidesOffset(), !(l || r.cssMode || "slide" !== r.effect && "fade" !== r.effect)) {
                    const e = `${r.containerModifierClass}backface-hidden`,
                        n = t.$el.hasClass(e);
                    p <= r.maxBackfaceHiddenSlides ? n || t.$el.addClass(e) : n && t.$el.removeClass(e)
                }
            },
            updateAutoHeight: function(t) {
                ...
                if ("auto" !== e.params.slidesPerView && e.params.slidesPerView > 1)
                    if (e.params.centeredSlides)(e.visibleSlides || c([])).each((t => {
                        n.push(t)
                    }));
                    else
            ...
            translateTo: function(t, e, n, r, s) {
                ...
                if (u = r && t > l ? l : r && t < c ? c : t, i.updateProgress(u), a.cssMode) {
                    ...
                    if (0 === e) o[t ? "scrollLeft" : "scrollTop"] = -u;
                        ...
                        if (!i.support.smoothScroll) return y({
                            swiper: i,
                            targetPosition: -u,
                            side: t ? "left" : "top"
                        }), !0;
    ...
    function P(t) {
        ...
        let o = r;
        if (o || (o = i > a ? "next" : i < a ? "prev" : "reset"), e.emit(`transition${s}`), n && i !== a) {
    ...
    var M = {
            slideTo: function(t, e, n, r, s) {
                ...
                if (i.initialized && a !== p) {
                    ...
                    if (!i.allowSlidePrev && v > i.translate && v > i.maxTranslate() && (p || 0) !== a) return !1
                }
                let b;
                if (a !== (u || 0) && n && i.emit("beforeSlideChangeStart"), i.updateProgress(v), b = a > p ? "next" : a < p ? "prev" : "reset", d && -v === i.translate || !d && v === i.translate) return i.updateActiveIndex(a), o.autoHeight && i.updateAutoHeight(), i.updateSlidesClasses(), "slide" !== o.effect && i.setTranslate(v), "reset" !== b && (i.transitionStart(n, b), i.transitionEnd(n, b)), !1;
                if (o.cssMode) {
                    const t = i.isHorizontal(),
                        n = d ? v : -v;
                    if (0 === e) {
                        const e = i.virtual && i.params.virtual.enabled;
                        e && (i.wrapperEl.style.scrollSnapType = "none", i._immediateVirtual = !0), f[t ? "scrollLeft" : "scrollTop"] = n, e && requestAnimationFrame((() => {
                ...
                return i.setTransition(e), i.setTranslate(v), i.updateActiveIndex(a), i.updateSlidesClasses(), i.emit("beforeTransitionStart", e, r), i.transitionStart(n, b), 0 === e ? i.transitionEnd(n, b) : i.animating || (i.animating = !0, i.onSlideToWrapperTransitionEnd || (i.onSlideToWrapperTransitionEnd = function(t) {
            ...
            slideToLoop: function(t, e, n, r) {
                if (void 0 === t && (t = 0), void 0 === e && (e = this.params.speed), void 0 === n && (n = !0), "string" == typeof t) {
                    const e = parseInt(t, 10);
                    if (!isFinite(e)) throw new Error(`The passed-in 'index' (string) couldn't be converted to 'number'. [${t}] given.`);
                    t = e
                }
            ...
            slidePrev: function(t, e, n) {
                ...
                let h = 0;
                if (void 0 !== f && (h = o.indexOf(f), h < 0 && (h = r.activeIndex - 1), "auto" === s.slidesPerView && 1 === s.slidesPerGroup && s.slidesPerGroupAuto && (h = h - r.slidesPerViewDynamic("previous", !0) + 1, h = Math.max(h, 0))), s.rewind && r.isBeginning) {
    ...
    function A(t) {
        ...
        if (o.noSwiping && (v ? function(t, e) {
                return void 0 === e && (e = this),
                    function e(n) {
                        if (!n || n === r() || n === i()) return null;
                        n.assignedSlot && (n = n.assignedSlot);
                        const s = n.closest(t);
                        return s || n.getRootNode ? s || e(n.getRootNode().host) : null
                    }(e)
            }(g, f[0]) : f.closest(g)[0])) return void(e.allowClick = !0);
        ...
        if (Object.assign(a, {
                ...
                isScrolling: void 0,
                startMoving: void 0
            }), l.startX = y, l.startY = b, a.touchStartTime = d(), e.allowClick = !0, e.updateSize(), e.swipeDirection = void 0, o.threshold > 0 && (a.allowThresholdMove = !1), "touchstart" !== p.type) {
            let t = !0;
            f.is(a.focusableElements) && (t = !1, "SELECT" === f[0].nodeName && (a.isTouched = !1)), n.activeElement && c(n.activeElement).is(a.focusableElements) && n.activeElement !== f[0] && n.activeElement.blur();
            const r = t && e.allowTouchMove && o.touchStartPreventDefault;
            !o.touchStartForcePreventDefault && !r || f[0].isContentEditable || p.preventDefault()
        }
        e.params.freeMode && e.params.freeMode.enabled && e.freeMode && e.animating && !o.cssMode && e.freeMode.onTouchStart(), e.emit("touchStart", p)
    }
    ...
    function j(t) {
        ...
        if (!n.allowTouchMove) return c(u.target).is(s.focusableElements) || (n.allowClick = !1), void(s.isTouched && (Object.assign(a, {
            startX: f,
            startY: h,
            currentX: f,
            currentY: h
        ...
        if (s.isTouchEvent && i.touchReleaseOnEdges && !i.loop)
            if (n.isVertical()) {
                if (h < a.startY && n.translate <= n.maxTranslate() || h > a.startY && n.translate >= n.minTranslate()) return s.isTouched = !1, void(s.isMoved = !1)
    ...
    function $(t) {
        ...
        let f;
        if (n.isTouched = !1, n.isMoved = !1, n.startMoving = !1, f = r.followFinger ? i ? e.translate : -e.translate : -n.currentTranslate, r.cssMode) return;
        ...
        for (let t = 0; t < a.length; t += t < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
            ...
            void 0 !== a[t + e] ? f >= a[t] && f < a[t + e] && (h = t, m = a[t + e] - a[t]) : f >= a[t] && (h = t, m = a[a.length - 1] - a[a.length - 2])
        }
        let g = null,
            v = null;
        r.rewind && (e.isBeginning ? v = e.params.virtual && e.params.virtual.enabled && e.virtual ? e.virtual.slides.length - 1 : e.slides.length - 1 : e.isEnd && (g = 0));
        const y = (f - a[h]) / m,
            b = h < r.slidesPerGroupSkip - 1 ? 1 : r.slidesPerGroup;
        if (u > r.longSwipesMs) {
            if (!r.longSwipes) return void e.slideTo(e.activeIndex);
            "next" === e.swipeDirection && (y >= r.longSwipesRatio ? e.slideTo(r.rewind && e.isEnd ? g : h + b) : e.slideTo(h)), "prev" === e.swipeDirection && (y > 1 - r.longSwipesRatio ? e.slideTo(h + b) : null !== v && y < 0 && Math.abs(y) > r.longSwipesRatio ? e.slideTo(v) : e.slideTo(h))
        } else {
            if (!r.shortSwipes) return void e.slideTo(e.activeIndex);
            !e.navigation || l.target !== e.navigation.nextEl && l.target !== e.navigation.prevEl ? ("next" === e.swipeDirection && e.slideTo(null !== g ? g : h + b), "prev" === e.swipeDirection && e.slideTo(null !== v ? v : h)) : l.target === e.navigation.nextEl ? e.slideTo(h + b) : e.slideTo(h)
        }
    }
    ...
    const H = (t, e) => {
        ...
        (s.preventClicks || s.preventClicksPropagation) && a[p]("click", t.onClick, !0), s.cssMode && o[p]("scroll", t.onScroll), s.updateOnWindowResize ? t[d](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", D, !0) : t[d]("observerUpdate", D, !0)
    };
    var R = {
        attachEvents: function() {
            ...
            t.onTouchStart = A.bind(t), t.onTouchMove = j.bind(t), t.onTouchEnd = $.bind(t), n.cssMode && (t.onScroll = L.bind(t)), t.onClick = I.bind(t), s.touch && !V && (e.addEventListener("touchstart", N), V = !0), H(t, "on")
        },
            ...
            breakpoints: {
                setBreakpoint: function() {
                    ...
                    const l = (o in a ? a[o] : void 0) || t.originalParams,
                        ...
                        u = z(t, l),
                        p = s.enabled;
                    c && !u ? (i.removeClass(`${s.containerModifierClass}grid ${s.containerModifierClass}grid-column`), t.emitContainerClasses()) : !c && u && (i.addClass(`${s.containerModifierClass}grid`), (l.grid.fill && "column" === l.grid.fill || !l.grid.fill && "column" === s.grid.fill) && i.addClass(`${s.containerModifierClass}grid-column`), t.emitContainerClasses()), ["navigation", "pagination", "scrollbar"].forEach((e => {
                    ...
                    }), p && !h ? t.disable() : !p && h && t.enable(), t.currentBreakpoint = o, t.emit("_beforeBreakpoint", l), f && n && (t.loopDestroy(), t.loopCreate(), t.updateSlides(), t.slideTo(e - r + t.loopedSlides, 0, !1)), t.emit("breakpoint", l)
                },
    ...
    class G {
        constructor() {
            ...
            if (1 === r.length && r[0].constructor && "Object" === Object.prototype.toString.call(r[0]).slice(8, -1) ? e = r[0] : [t, e] = r, e || (e = {}), e = g({}, e), t && !e.el && (e.el = t), e.el && c(e.el).length > 1) {
                const t = [];
                return c(e.el).each((n => {
                    const r = g({}, e, {
                        el: n
                    });
                    t.push(new G(r))
            ...
            const i = this;
            i.__swiper__ = !0, i.support = S(), i.device = C({
                userAgent: e.userAgent
            }), i.browser = x(), i.eventsListeners = {}, i.eventsAnyListeners = [], i.modules = [...i.__modules__], e.modules && Array.isArray(e.modules) && i.modules.push(...e.modules);
            const a = {};
            i.modules.forEach((t => {
                t({
                    swiper: i,
            ...
            const o = g({}, B, a);
            return i.params = g({}, o, U, e), i.originalParams = g({}, i.params), i.passedParams = g({}, e), i.params && i.params.on && Object.keys(i.params.on).forEach((t => {
    ...
    function et(t) {
        ...
        r("beforeInit", (() => {
            ...
            if (n.params.effect === e && l) {
                ...
                n.slides.each((t => {
                    n.$(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").remove()
                })), l()
            }
        })), r("virtualUpdate", (() => {
            n.params.effect === e && (n.slides.length || (u = !0), requestAnimationFrame((() => {
    ...
    function rt(t) {
        ...
        if (e.params.virtualTranslate && 0 !== n) {
            let t, n = !1;
            t = s ? r ? i.find(r) : i : r ? i.eq(a).find(r) : i.eq(a), t.transitionEnd((() => {
                if (n) return;
            ...
            e.params.resizeObserver && void 0 !== s.ResizeObserver ? e && !e.destroyed && e.initialized && (a = new ResizeObserver((t => {
                o = s.requestAnimationFrame((() => {
                    ...
                    t.forEach((t => {
                        ...
                        a && a !== e.el || (s = r ? r.width : (n[0] || n).inlineSize, i = r ? r.height : (n[0] || n).blockSize)
                    })), s === n && i === r || l()
                }))
            })), a.observe(e.el)) : (s.addEventListener("resize", l), s.addEventListener("orientationchange", c))
        })), n("destroy", (() => {
            o && s.cancelAnimationFrame(o), a && a.unobserve && e.el && (a.unobserve(e.el), a = null), s.removeEventListener("resize", l), s.removeEventListener("orientationchange", c)
        }))
    }, function(t) {
        let {
            swiper: e,
    ...
    const it = [function(t) {
        ...
        function a(t, e) {
            ...
            const s = r.renderSlide ? c(r.renderSlide.call(n, t, e)) : c(`<div class="${n.params.slideClass}" data-swiper-slide-index="${e}">${t}</div>`);
            return s.attr("data-swiper-slide-index") || s.attr("data-swiper-slide-index", e), r.cache && (n.virtual.cache[e] = s), s
        }
        ...
        function o(t) {
            ...
            let m, g, v;
            m = n.rtlTranslate ? "right" : n.isHorizontal() ? "left" : "top", s ? (g = Math.floor(e / 2) + r + l, v = Math.floor(e / 2) + r + o) : (g = e + (r - 1) + l, v = r + o);
            const y = Math.max((h || 0) - v, 0),
                b = Math.min((h || 0) + g, p.length - 1),
                _ = (n.slidesGrid[y] || 0) - (n.slidesGrid[0] || 0);

            function w() {
                n.updateSlides(), n.updateProgress(), n.updateSlidesClasses(), n.lazy && n.params.lazy.enabled && n.lazy.load(), i("virtualUpdate")
            }
            if (Object.assign(n.virtual, {
                ...
                }), c === y && u === b && !t) return n.slidesGrid !== d && _ !== f && n.slides.css(m, `${_}px`), n.updateProgress(), void i("virtualUpdate");
            ...
            }), void(n.params.virtual.renderExternalUpdate ? w() : i("virtualUpdate"));
            const S = [],
                C = [];
            if (t) n.$wrapperEl.find(`.${n.params.slideClass}`).remove();
            else
                for (let t = c; t <= u; t += 1)(t < y || t > b) && n.$wrapperEl.find(`.${n.params.slideClass}[data-swiper-slide-index="${t}"]`).remove();
            for (let e = 0; e < p.length; e += 1) e >= y && e <= b && (void 0 === u || t ? C.push(e) : (e > u && C.push(e), e < c && S.push(e)));
            C.forEach((t => {
                n.$wrapperEl.append(a(p[t], t))
            })), S.sort(((t, e) => e - t)).forEach((t => {
                n.$wrapperEl.prepend(a(p[t], t))
            })), n.$wrapperEl.children(".swiper-slide").css(m, `${_}px`), w()
        }
        r({
            virtual: {
                enabled: !1,
            ...
            n.params.virtual.enabled && (n.params.cssMode && !n._immediateVirtual ? (clearTimeout(e), e = setTimeout((() => {
                o()
            }), 100)) : o())
            ...
            appendSlide: function(t) {
                if ("object" == typeof t && "length" in t)
                    for (let e = 0; e < t.length; e += 1) t[e] && n.virtual.slides.push(t[e]);
            ...
            prependSlide: function(t) {
                ...
                let r = e + 1,
                    s = 1;
                if (Array.isArray(t)) {
                    for (let e = 0; e < t.length; e += 1) t[e] && n.virtual.slides.unshift(t[e]);
                ...
                if (n.params.virtual.cache) {
                    ...
                    Object.keys(t).forEach((n => {
                        ...
                        i && r.attr("data-swiper-slide-index", parseInt(i, 10) + s), e[parseInt(n, 10) + s] = r
                    })), n.virtual.cache = e
                }
                o(!0), n.slideTo(r, 0)
            },
            removeSlide: function(t) {
                ...
                let e = n.activeIndex;
                if (Array.isArray(t))
                    for (let r = t.length - 1; r >= 0; r -= 1) n.virtual.slides.splice(t[r], 1), n.params.virtual.cache && delete n.virtual.cache[t[r]], t[r] < e && (e -= 1), e = Math.max(e, 0);
                else n.virtual.slides.splice(t, 1), n.params.virtual.cache && delete n.virtual.cache[t], t < e && (e -= 1), e = Math.max(e, 0);
                o(!0), n.slideTo(e, 0)
            },
        ...
        function u(t) {
            ...
            const s = r.keyCode || r.charCode,
                ...
                f = 38 === s,
                h = 40 === s;
            if (!e.allowSlideNext && (e.isHorizontal() && d || e.isVertical() && h || u)) return !1;
            if (!e.allowSlidePrev && (e.isHorizontal() && p || e.isVertical() && f || c)) return !1;
            if (!(r.shiftKey || r.altKey || r.ctrlKey || r.metaKey || o.activeElement && o.activeElement.nodeName && ("input" === o.activeElement.nodeName.toLowerCase() || "textarea" === o.activeElement.nodeName.toLowerCase()))) {
                if (e.params.keyboard.onlyInViewport && (c || u || p || d || f || h)) {
                    let t = !1;
                ...
                e.isHorizontal() ? ((c || u || p || d) && (r.preventDefault ? r.preventDefault() : r.returnValue = !1), ((u || d) && !n || (c || p) && n) && e.slideNext(), ((c || p) && !n || (u || d) && n) && e.slidePrev()) : ((c || u || f || h) && (r.preventDefault ? r.preventDefault() : r.returnValue = !1), (u || h) && e.slideNext(), (c || f) && e.slidePrev()), a("keyPress", s)
            }
        }

        function p() {
            e.keyboard.enabled || (c(o).on("keydown", u), e.keyboard.enabled = !0)
        }

        function d() {
            e.keyboard.enabled && (c(o).off("keydown", u), e.keyboard.enabled = !1)
        }
        e.keyboard = {
            enabled: !1
        }, n({
        ...
        function g(t) {
            return !(e.params.mousewheel.thresholdDelta && t.delta < e.params.mousewheel.thresholdDelta || e.params.mousewheel.thresholdTime && d() - u < e.params.mousewheel.thresholdTime || !(t.delta >= 6 && d() - u < 60) && (t.direction < 0 ? e.isEnd && !e.params.loop || e.animating || (e.slideNext(), s("scroll", t.raw)) : e.isBeginning && !e.params.loop || e.animating || (e.slidePrev(), s("scroll", t.raw)), u = (new a.Date).getTime(), 1))
        }
        ...
        function v(t) {
            ...
            let a = e.$el;
            if ("container" !== e.params.mousewheel.eventsTarget && (a = c(e.params.mousewheel.eventsTarget)), !e.mouseEntered && !a[0].contains(n.target) && !i.releaseOnEdges) return !0;
            ...
            if (v >= e.minTranslate() && (v = e.minTranslate()), v <= e.maxTranslate() && (v = e.maxTranslate()), r = !!e.params.loop || !(v === e.minTranslate() || v === e.maxTranslate()), r && e.params.nested && n.stopPropagation(), e.params.freeMode && e.params.freeMode.enabled) {
                const t = {
                    ...
                    r = l && t.time < l.time + 500 && t.delta <= l.delta && t.direction === l.direction;
                if (!r) {
                    l = void 0, e.params.loop && e.loopFix();
                    let a = e.getTranslate() + u * i.sensitivity;
                    const c = e.isBeginning,
                        d = e.isEnd;
                    if (a >= e.minTranslate() && (a = e.minTranslate()), a <= e.maxTranslate() && (a = e.maxTranslate()), e.setTransition(0), e.setTranslate(a), e.updateProgress(), e.updateActiveIndex(), e.updateSlidesClasses(), (!c && e.isBeginning || !d && e.isEnd) && e.updateSlidesClasses(), e.params.freeMode.sticky) {
                        clearTimeout(o), o = void 0, f.length >= 15 && f.shift();
                        const n = f.length ? f[f.length - 1] : void 0,
                            r = f[0];
                        if (f.push(t), n && (t.delta > n.delta || t.direction !== n.direction)) f.splice(0);
                        else if (f.length >= 15 && t.time - r.time < 500 && r.delta - t.delta >= 1 && t.delta <= 6) {
                            const n = u > 0 ? .8 : .2;
                            l = t, f.splice(0), o = p((() => {
                        ...
                        o || (o = p((() => {
                            l = t, f.splice(0), e.slideToClosest(e.params.speed, !0, void 0, .5)
                        }), 500))
                    }
                    if (r || s("scroll", n), e.params.autoplay && e.params.autoplayDisableOnInteraction && e.autoplay.stop(), a === e.minTranslate() || a === e.maxTranslate()) return !0
                }
            } else {
                const n = {
                    time: d(),
                ...
                if (f.push(n), r ? (n.direction !== r.direction || n.delta > r.delta || n.time > r.time + 150) && g(n) : g(n), function(t) {
        ...
        function y(t) {
            let n = e.$el;
            "container" !== e.params.mousewheel.eventsTarget && (n = c(e.params.mousewheel.eventsTarget)), n[t]("mouseenter", h), n[t]("mouseleave", m), n[t]("wheel", v)
        }
        ...
        r("init", (() => {
            !e.params.mousewheel.enabled && e.params.cssMode && _(), e.params.mousewheel.enabled && b()
        })), r("destroy", (() => {
        ...
        function p() {
            ...
            const n = i(t.nextEl),
                r = i(t.prevEl);
            n && n.length > 0 && n.on("click", u), r && r.length > 0 && r.on("click", l), Object.assign(e.navigation, {
                $nextEl: n,
                nextEl: n && n[0],
                $prevEl: r,
                prevEl: r && r[0]
        ...
        function d() {
            ...
            t && t.length && (t.off("click", u), t.removeClass(e.params.navigation.disabledClass)), n && n.length && (n.off("click", l), n.removeClass(e.params.navigation.disabledClass))
        }
        n({
            navigation: {
                nextEl: null,
            ...
            if (e.params.navigation.hideOnClick && !c(a).is(i) && !c(a).is(r)) {
                ...
                let t;
                r ? t = r.hasClass(e.params.navigation.hiddenClass) : i && (t = i.hasClass(e.params.navigation.hiddenClass)), s(!0 === t ? "navigationShow" : "navigationHide"), r && r.toggleClass(e.params.navigation.hiddenClass), i && i.toggleClass(e.params.navigation.hiddenClass)
            }
        }));
        const f = () => {
        ...
        function p() {
            ...
            if (e.params.loop ? (p = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup), p > r - 1 - 2 * e.loopedSlides && (p -= r - 2 * e.loopedSlides), p > d - 1 && (p -= d), p < 0 && "bullets" !== e.params.paginationType && (p = d + p)) : p = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === n.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                const r = e.pagination.bullets;
                let s, l, d;
                if (n.dynamicBullets && (a = r.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), i.css(e.isHorizontal() ? "width" : "height", a * (n.dynamicMainBullets + 4) + "px"), n.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (o += p - (e.previousIndex - e.loopedSlides || 0), o > n.dynamicMainBullets - 1 ? o = n.dynamicMainBullets - 1 : o < 0 && (o = 0)), s = Math.max(p - o, 0), l = s + (Math.min(r.length, n.dynamicMainBullets) - 1), d = (l + s) / 2), r.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((t => `${n.bulletActiveClass}${t}`)).join(" ")), i.length > 1) r.each((t => {
                    const e = c(t),
                        r = e.index();
                    r === p && e.addClass(n.bulletActiveClass), n.dynamicBullets && (r >= s && r <= l && e.addClass(`${n.bulletActiveClass}-main`), r === s && u(e, "prev"), r === l && u(e, "next"))
                }));
                else {
                    const t = r.eq(p),
                        i = t.index();
                    if (t.addClass(n.bulletActiveClass), n.dynamicBullets) {
                        const t = r.eq(s),
                            a = r.eq(l);
                        for (let t = s; t <= l; t += 1) r.eq(t).addClass(`${n.bulletActiveClass}-main`);
                        if (e.params.loop)
                            if (i >= r.length) {
            ...
            if ("fraction" === n.type && (i.find(X(n.currentClass)).text(n.formatFractionCurrent(p + 1)), i.find(X(n.totalClass)).text(n.formatFractionTotal(d))), "progressbar" === n.type) {
                let t;
                t = n.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
                const r = (p + 1) / d;
                let s = 1,
                    a = 1;
                "horizontal" === t ? s = r : a = r, i.find(X(n.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${s}) scaleY(${a})`).transition(e.params.speed)
            }
            "custom" === n.type && n.renderCustom ? (i.html(n.renderCustom(e, p + 1, d)), s("paginationRender", i[0])) : s("paginationUpdate", i[0]), e.params.watchOverflow && e.enabled && i[e.isLocked ? "addClass" : "removeClass"](n.lockClass)
        }
        ...
        function h() {
            ...
            n.removeClass(t.hiddenClass), n.removeClass(t.modifierClass + t.type), n.removeClass(e.isHorizontal() ? t.horizontalClass : t.verticalClass), e.pagination.bullets && e.pagination.bullets.removeClass && e.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && n.off("click", X(t.bulletClass))
        }
        r("init", (() => {
            ...
            if (e.params.pagination.el && e.params.pagination.hideOnClick && i && i.length > 0 && !c(r).hasClass(e.params.pagination.bulletClass)) {
                ...
                s(!0 === t ? "paginationShow" : "paginationHide"), i.toggleClass(e.params.pagination.hiddenClass)
            }
        }));
        const m = () => {
        ...
        Object.assign(e.pagination, {
            enable: () => {
                e.$el.removeClass(e.params.pagination.paginationDisabledClass), e.pagination.$el && e.pagination.$el.removeClass(e.params.pagination.paginationDisabledClass), f(), d(), p()
            },
            disable: m,
            render: d,
            update: p,
        ...
        function g() {
            ...
            let o = l,
                c = (u - l) * r;
            n ? (c = -c, c > 0 ? (o = l - c, c = 0) : -c + l > u && (o = u + c)) : c < 0 ? (o = l + c, c = 0) : c + l > u && (o = u - c), e.isHorizontal() ? (s.transform(`translate3d(${c}px, 0, 0)`), s[0].style.width = `${o}px`) : (s.transform(`translate3d(0px, ${c}px, 0)`), s[0].style.height = `${o}px`), a.hide && (clearTimeout(h), i[0].style.opacity = 1, h = setTimeout((() => {
        ...
        function v() {
            ...
            n[0].style.width = "", n[0].style.height = "", u = e.isHorizontal() ? r[0].offsetWidth : r[0].offsetHeight, d = e.size / (e.virtualSize + e.params.slidesOffsetBefore - (e.params.centeredSlides ? e.snapGrid[0] : 0)), l = "auto" === e.params.scrollbar.dragSize ? u * d : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? n[0].style.width = `${l}px` : n[0].style.height = `${l}px`, r[0].style.display = d >= 1 ? "none" : "", e.params.scrollbar.hide && (r[0].style.opacity = 0), e.params.watchOverflow && e.enabled && t.$el[e.isLocked ? "addClass" : "removeClass"](e.params.scrollbar.lockClass)
        }
        ...
        function b(t) {
            ...
            let i;
            i = (y(t) - s.offset()[e.isHorizontal() ? "left" : "top"] - (null !== o ? o : l / 2)) / (u - l), i = Math.max(Math.min(i, 1), 0), r && (i = 1 - i);
            const a = e.minTranslate() + (e.maxTranslate() - e.minTranslate()) * i;
        ...
        function _(t) {
            ...
            f = !0, o = t.target === l[0] || t.target === l ? y(t) - t.target.getBoundingClientRect()[e.isHorizontal() ? "left" : "top"] : null, t.preventDefault(), t.stopPropagation(), s.transition(100), l.transition(100), b(t), clearTimeout(m), a.transition(0), n.hide && a.css("opacity", 1), e.params.cssMode && e.$wrapperEl.css("scroll-snap-type", "none"), i("scrollbarDragStart", t)
        }
        ...
        function w(t) {
            ...
            f && (t.preventDefault ? t.preventDefault() : t.returnValue = !1, b(t), r.transition(0), s.transition(0), a.transition(0), i("scrollbarDragMove", t))
        }
        ...
        function S(t) {
            ...
            f && (f = !1, e.params.cssMode && (e.$wrapperEl.css("scroll-snap-type", ""), s.transition("")), n.hide && (clearTimeout(m), m = p((() => {
        ...
        function C(t) {
            ...
            o.touch ? (c[d](r.start, _, u), c[d](r.move, w, u), c[d](r.end, S, p)) : (c[d](s.start, _, u), a[d](s.move, w, u), a[d](s.end, S, p))
        }
        ...
        function x() {
            ...
            if (!r.el) return;
            let s = c(r.el);
            e.params.uniqueNavElements && "string" == typeof r.el && s.length > 1 && 1 === n.find(r.el).length && (s = n.find(r.el)), s.addClass(e.isHorizontal() ? r.horizontalClass : r.verticalClass);
            let i = s.find(`.${e.params.scrollbar.dragClass}`);
            0 === i.length && (i = c(`<div class="${e.params.scrollbar.dragClass}"></div>`), s.append(i)), Object.assign(t, {
                $el: s,
                el: s[0],
                $dragEl: i,
                dragEl: i[0]
            }), r.draggable && e.params.scrollbar.el && e.scrollbar.el && C("on"), s && s[e.enabled ? "removeClass" : "addClass"](e.params.scrollbar.lockClass)
        }

        function k() {
            const t = e.params.scrollbar,
                n = e.scrollbar.$el;
            n && n.removeClass(e.isHorizontal() ? t.horizontalClass : t.verticalClass), e.params.scrollbar.el && e.scrollbar.el && C("off")
        }
        n({
            scrollbar: {
                el: null,
        ...
        const E = () => {
            e.$el.addClass(e.params.scrollbar.scrollbarDisabledClass), e.scrollbar.$el && e.scrollbar.$el.addClass(e.params.scrollbar.scrollbarDisabledClass), k()
        };
        Object.assign(e.scrollbar, {
            enable: () => {
                e.$el.removeClass(e.params.scrollbar.scrollbarDisabledClass), e.scrollbar.$el && e.scrollbar.$el.removeClass(e.params.scrollbar.scrollbarDisabledClass), x(), v(), g()
            },
            disable: E,
            updateSize: v,
            setTranslate: g,
        ...
        const s = (t, n) => {
                const {
                    rtl: r
                } = e, s = c(t), i = r ? -1 : 1, a = s.attr("data-swiper-parallax") || "0";
                let o = s.attr("data-swiper-parallax-x"),
                    l = s.attr("data-swiper-parallax-y");
                const u = s.attr("data-swiper-parallax-scale"),
                    p = s.attr("data-swiper-parallax-opacity");
                if (o || l ? (o = o || "0", l = l || "0") : e.isHorizontal() ? (o = a, l = "0") : (l = a, o = "0"), o = o.indexOf("%") >= 0 ? parseInt(o, 10) * n * i + "%" : o * n * i + "px", l = l.indexOf("%") >= 0 ? parseInt(l, 10) * n + "%" : l * n + "px", null != p) {
            ...
            i = () => {
                ...
                t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((t => {
                    ...
                    let a = t.progress;
                    e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (a += Math.ceil(n / 2) - r * (i.length - 1)), a = Math.min(Math.max(a, -1), 1), c(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((t => {
                        s(t, a)
                    }))
                }))
            };
        ...
        function _(t) {
            ...
            h.$imageEl && 0 !== h.$imageEl.length ? (n.gestures ? s.scale = t.scale * p : s.scale = h.scaleMove / h.scaleStart * p, s.scale > h.maxRatio && (s.scale = h.maxRatio - 1 + (s.scale - h.maxRatio + 1) ** .5), s.scale < r.minRatio && (s.scale = r.minRatio + 1 - (r.minRatio - s.scale + 1) ** .5), h.$imageEl.transform(`translate3d(0,0,0) scale(${s.scale})`)) : "gesturechange" === t.type && b(t)
        }
        ...
        function w(t) {
            ...
            h.$imageEl && 0 !== h.$imageEl.length && (i.scale = Math.max(Math.min(i.scale, h.maxRatio), s.minRatio), h.$imageEl.transition(e.params.speed).transform(`translate3d(0,0,0) scale(${i.scale})`), p = i.scale, d = !1, 1 === i.scale && (h.$slideEl = void 0))
        }
        ...
        function S(t) {
            ...
            if (!(r < h.slideWidth && s < h.slideHeight)) {
                if (m.minX = Math.min(h.slideWidth / 2 - r / 2, 0), m.maxX = -m.minX, m.minY = Math.min(h.slideHeight / 2 - s / 2, 0), m.maxY = -m.minY, m.touchesCurrent.x = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, m.touchesCurrent.y = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, !m.isMoved && !d) {
                    if (e.isHorizontal() && (Math.floor(m.minX) === Math.floor(m.startX) && m.touchesCurrent.x < m.touchesStart.x || Math.floor(m.maxX) === Math.floor(m.startX) && m.touchesCurrent.x > m.touchesStart.x)) return void(m.isTouched = !1);
                    if (!e.isHorizontal() && (Math.floor(m.minY) === Math.floor(m.startY) && m.touchesCurrent.y < m.touchesStart.y || Math.floor(m.maxY) === Math.floor(m.startY) && m.touchesCurrent.y > m.touchesStart.y)) return void(m.isTouched = !1)
                }
                t.cancelable && t.preventDefault(), t.stopPropagation(), m.isMoved = !0, m.currentX = m.touchesCurrent.x - m.touchesStart.x + m.startX, m.currentY = m.touchesCurrent.y - m.touchesStart.y + m.startY, m.currentX < m.minX && (m.currentX = m.minX + 1 - (m.minX - m.currentX + 1) ** .8), m.currentX > m.maxX && (m.currentX = m.maxX - 1 + (m.currentX - m.maxX + 1) ** .8), m.currentY < m.minY && (m.currentY = m.minY + 1 - (m.minY - m.currentY + 1) ** .8), m.currentY > m.maxY && (m.currentY = m.maxY - 1 + (m.currentY - m.maxY + 1) ** .8), g.prevPositionX || (g.prevPositionX = m.touchesCurrent.x), g.prevPositionY || (g.prevPositionY = m.touchesCurrent.y), g.prevTime || (g.prevTime = Date.now()), g.x = (m.touchesCurrent.x - g.prevPositionX) / (Date.now() - g.prevTime) / 2, g.y = (m.touchesCurrent.y - g.prevPositionY) / (Date.now() - g.prevTime) / 2, Math.abs(m.touchesCurrent.x - g.prevPositionX) < 2 && (g.x = 0), Math.abs(m.touchesCurrent.y - g.prevPositionY) < 2 && (g.y = 0), g.prevPositionX = m.touchesCurrent.x, g.prevPositionY = m.touchesCurrent.y, g.prevTime = Date.now(), h.$imageWrapEl.transform(`translate3d(${m.currentX}px, ${m.currentY}px,0)`)
            }
        }

        function C() {
            const t = e.zoom;
            h.$slideEl && e.previousIndex !== e.activeIndex && (h.$imageEl && h.$imageEl.transform("translate3d(0,0,0) scale(1)"), h.$imageWrapEl && h.$imageWrapEl.transform("translate3d(0,0,0)"), t.scale = 1, p = 1, h.$slideEl = void 0, h.$imageEl = void 0, h.$imageWrapEl = void 0)
        }
        ...
        function M(t) {
            ...
            e.$wrapperEl[t]("gesturestart", r, b, n), e.$wrapperEl[t]("gesturechange", r, _, n), e.$wrapperEl[t]("gestureend", r, w, n)
        }
        ...
        function j() {
            ...
            const n = e.support,
                ...
                i = P();
            n.gestures ? (e.$wrapperEl.on(e.touchEvents.start, O, r), e.$wrapperEl.on(e.touchEvents.end, A, r)) : "touchstart" === e.touchEvents.start && (e.$wrapperEl.on(e.touchEvents.start, i, b, r), e.$wrapperEl.on(e.touchEvents.move, i, _, s), e.$wrapperEl.on(e.touchEvents.end, i, w, r), e.touchEvents.cancel && e.$wrapperEl.on(e.touchEvents.cancel, i, w, r)), e.$wrapperEl.on(e.touchEvents.move, `.${e.params.zoom.containerClass}`, S, s)
        }
        ...
        function $() {
            ...
            n.gestures ? (e.$wrapperEl.off(e.touchEvents.start, O, r), e.$wrapperEl.off(e.touchEvents.end, A, r)) : "touchstart" === e.touchEvents.start && (e.$wrapperEl.off(e.touchEvents.start, i, b, r), e.$wrapperEl.off(e.touchEvents.move, i, _, s), e.$wrapperEl.off(e.touchEvents.end, i, w, r), e.touchEvents.cancel && e.$wrapperEl.off(e.touchEvents.cancel, i, w, r)), e.$wrapperEl.off(e.touchEvents.move, `.${e.params.zoom.containerClass}`, S, s)
        }
        Object.defineProperty(e.zoom, "scale", {
            ...
            e.zoom.enabled && function(t) {
                const n = e.device;
                h.$imageEl && 0 !== h.$imageEl.length && (m.isTouched || (n.android && t.cancelable && t.preventDefault(), m.isTouched = !0, m.touchesStart.x = "touchstart" === t.type ? t.targetTouches[0].pageX : t.pageX, m.touchesStart.y = "touchstart" === t.type ? t.targetTouches[0].pageY : t.pageY))
            }(n)
        })), r("touchEnd", ((t, n) => {
            e.zoom.enabled && function() {
                ...
                const s = g.x * n,
                    ...
                    a = g.y * r,
                    o = m.currentY + a;
                0 !== g.x && (n = Math.abs((i - m.currentX) / g.x)), 0 !== g.y && (r = Math.abs((o - m.currentY) / g.y));
        ...
        function l(t, n) {
            ...
            const i = e.virtual && e.params.virtual.enabled ? e.$wrapperEl.children(`.${e.params.slideClass}[data-swiper-slide-index="${t}"]`) : e.slides.eq(t),
                a = i.find(`.${r.elementClass}:not(.${r.loadedClass}):not(.${r.loadingClass})`);
            !i.hasClass(r.elementClass) || i.hasClass(r.loadedClass) || i.hasClass(r.loadingClass) || a.push(i[0]), 0 !== a.length && a.each((t => {
                const a = c(t);
                ...
                e.loadImage(a[0], u || o, p, d, !1, (() => {
                    if (null != e && e && (!e || e.params) && !e.destroyed) {
                        if (o ? (a.css("background-image", `url("${o}")`), a.removeAttr("data-background")) : (p && (a.attr("srcset", p), a.removeAttr("data-srcset")), d && (a.attr("sizes", d), a.removeAttr("data-sizes")), f.length && f.children("source").each((t => {
                                const e = c(t);
                                e.attr("data-srcset") && (e.attr("srcset", e.attr("data-srcset")), e.removeAttr("data-srcset"))
                            })), u && (a.attr("src", u), a.removeAttr("data-src"))), a.addClass(r.loadedClass).removeClass(r.loadingClass), i.find(`.${r.preloaderClass}`).remove(), e.params.loop && n) {
                            const t = i.attr("data-swiper-slide-index");
                            i.hasClass(e.params.slideDuplicateClass) ? l(e.$wrapperEl.children(`[data-swiper-slide-index="${t}"]:not(.${e.params.slideDuplicateClass})`).index(), !1) : l(e.$wrapperEl.children(`.${e.params.slideDuplicateClass}[data-swiper-slide-index="${t}"]`).index(), !1)
                        }
                        s("lazyImageReady", i[0], a[0]), e.params.autoHeight && e.updateAutoHeight()
                    }
        ...
        function u() {
            const {
                ...
                slides: r,
                activeIndex: s
            } = e, i = e.virtual && n.virtual.enabled, a = n.lazy;
            ...
            if ("auto" === u && (u = 0), o || (o = !0), e.params.watchSlidesProgress) t.children(`.${n.slideVisibleClass}`).each((t => {
                l(i ? c(t).attr("data-swiper-slide-index") : c(t).index())
            }));
            else if (u > 1)
                for (let t = s; t < s + u; t += 1) p(t) && l(t);
            else l(s);
            if (a.loadPrevNext)
        ...
        function p() {
            ...
            f ? (u(), n.off("scroll", p, m)) : a || (a = !0, n.on("scroll", p, m))
        }
        r("beforeInit", (() => {
            ...
            e.params.lazy.enabled && (e.params.lazy.loadOnTransitionStart || !e.params.lazy.loadOnTransitionStart && !o) && (e.params.lazy.checkInView ? p() : u())
        })), r("transitionEnd", (() => {
            e.params.lazy.enabled && !e.params.lazy.loadOnTransitionStart && (e.params.lazy.checkInView ? p() : u())
        })), r("slideChange", (() => {
            const {
                lazy: t,
                cssMode: n,
        ...
        n({
            ...
            setTranslate: function(t, n) {
                ...
                function l(t) {
                    ...
                    }(t), a = -e.controller.spline.interpolate(-n)), a && "container" !== e.params.controller.by || (i = (t.maxTranslate() - t.minTranslate()) / (e.maxTranslate() - e.minTranslate()), a = (n - e.minTranslate()) * i + t.minTranslate()), e.params.controller.inverse && (a = t.maxTranslate() - a), t.updateProgress(a), t.setTranslate(a, e), t.updateActiveIndex(), t.updateSlidesClasses()
                }
                if (Array.isArray(r))
                    for (let t = 0; t < r.length; t += 1) r[t] !== n && r[t] instanceof o && l(r[t]);
            ...
            setTransition: function(t, n) {
                ...
                function a(n) {
                    n.setTransition(t, e), 0 !== t && (n.transitionStart(), n.params.autoHeight && p((() => {
                        n.updateAutoHeight()
        ...
        const v = (t, e, n) => {
                a(t), "BUTTON" !== t[0].tagName && (l(t, "button"), t.on("keydown", h)), p(t, n),
                    function(t, e) {
            ...
            _ = t => {
                ...
                r || s || (e.isHorizontal() ? e.el.scrollLeft = 0 : e.el.scrollTop = 0, e.slideTo(e.slides.indexOf(n), 0))
            },
            w = () => {
                const t = e.params.a11y;
                t.itemRoleDescriptionMessage && u(c(e.slides), t.itemRoleDescriptionMessage), t.slideRole && l(c(e.slides), t.slideRole);
                const n = e.params.loop ? e.slides.filter((t => !t.classList.contains(e.params.slideDuplicateClass))).length : e.slides.length;
                t.slideLabelMessage && e.slides.each(((r, s) => {
                    const i = c(r),
                        a = e.params.loop ? parseInt(i.attr("data-swiper-slide-index"), 10) : s;
                    p(i, t.slideLabelMessage.replace(/\{\{index\}\}/, a + 1).replace(/\{\{slidesLength\}\}/, n))
                }))
            };
        r("beforeInit", (() => {
            ...
            e.params.a11y.enabled && (() => {
                ...
                e.$el.append(s);
                const n = e.$el;
                t.containerRoleDescriptionMessage && u(n, t.containerRoleDescriptionMessage), t.containerMessage && p(n, t.containerMessage);
                const r = e.$wrapperEl,
                    i = t.id || r.attr("id") || `swiper-wrapper-${a=16,void 0===a&&(a=16),"x".repeat(a).replace(/x/g,(()=>Math.round(16*Math.random()).toString(16)))}`;
                var a;
                const o = e.params.autoplay && e.params.autoplay.enabled ? "off" : "polite";
                var l;
                let c, d;
                l = i, r.attr("id", l),
                    function(t, e) {
                        t.attr("aria-live", e)
                    }(r, o), w(), e.navigation && e.navigation.$nextEl && (c = e.navigation.$nextEl), e.navigation && e.navigation.$prevEl && (d = e.navigation.$prevEl), c && c.length && v(c, i, t.nextSlideMessage), d && d.length && v(d, i, t.prevSlideMessage), g() && e.pagination.$el.on("keydown", X(e.params.pagination.bulletClass), h), e.$el.on("focus", _, !0), e.$el.on("pointerdown", y, !0), e.$el.on("pointerup", b, !0)
            })()
            ...
            e.params.a11y.enabled && function() {
                ...
                n && n.length > 0 && (e.isBeginning ? (d(n), o(n)) : (f(n), a(n))), t && t.length > 0 && (e.isEnd ? (d(t), o(t)) : (f(t), a(t)))
            }()
        })), r("paginationUpdate", (() => {
            e.params.a11y.enabled && function() {
                const t = e.params.a11y;
                m() && e.pagination.bullets.each((n => {
                    const r = c(n);
                    e.params.pagination.clickable && (a(r), e.params.pagination.renderBullet || (l(r, "button"), p(r, t.paginationBulletMessage.replace(/\{\{index\}\}/, r.index() + 1)))), r.is(`.${e.params.pagination.bulletActiveClass}`) ? r.attr("aria-current", "true") : r.removeAttr("aria-current")
                }))
            }()
        })), r("destroy", (() => {
            e.params.a11y.enabled && function() {
                let t, n;
                s && s.length > 0 && s.remove(), e.navigation && e.navigation.$nextEl && (t = e.navigation.$nextEl), e.navigation && e.navigation.$prevEl && (n = e.navigation.$prevEl), t && t.off("keydown", h), n && n.off("keydown", h), g() && e.pagination.$el.off("keydown", X(e.params.pagination.bulletClass), h), e.$el.off("focus", _, !0), e.$el.off("pointerdown", y, !0), e.$el.off("pointerup", b, !0)
            }()
        }))
    }, function(t) {
        let {
        ...
        let s = !1,
            a = {};
        const o = t => t.toString().replace(/\s+/g, "-").replace(/[^\w-]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, ""),
            l = t => {
                const e = i();
                let n;
            ...
            c = (t, n) => {
                ...
                u && u.value === c || (e.params.history.replaceState ? r.history.replaceState({
                    value: c
            ...
            u = (t, n, r) => {
                if (n)
                    for (let s = 0, i = e.slides.length; s < i; s += 1) {
                        ...
                        if (o(i.attr("data-history")) === n && !i.hasClass(e.params.slideDuplicateClass)) {
                            const n = i.index();
                            e.slideTo(n, t, r)
                        }
        ...
        r("init", (() => {
            e.params.history.enabled && (() => {
                ...
                if (e.params.history) {
                    ...
                    s = !0, a = l(e.params.url), (a.key || a.value) && (u(0, a.value, e.params.runCallbacksOnInit), e.params.history.replaceState || t.addEventListener("popstate", p))
                }
            })()
        })), r("destroy", (() => {
            e.params.history.enabled && (() => {
        ...
        const p = () => {
            ...
            d = () => {
                if (o && e.params.hashNavigation.enabled)
                    if (e.params.hashNavigation.replaceState && u.history && u.history.replaceState) u.history.replaceState(null, null, `#${e.slides.eq(e.activeIndex).attr("data-hash")}` || ""), s("hashSet");
                    else {
        ...
        a("init", (() => {
            ...
            e.params.hashNavigation.enabled && e.params.hashNavigation.watchState && c(u).off("hashchange", p)
        ...
        function o() {
            ...
            t.attr("data-swiper-autoplay") && (r = t.attr("data-swiper-autoplay") || n.params.autoplay.delay), clearTimeout(e), e = p((() => {
                let t;
                n.params.autoplay.reverseDirection ? n.params.loop ? (n.loopFix(), t = n.slidePrev(n.params.speed, !0, !0), a("autoplay")) : n.isBeginning ? n.params.autoplay.stopOnLastSlide ? c() : (t = n.slideTo(n.slides.length - 1, n.params.speed, !0, !0), a("autoplay")) : (t = n.slidePrev(n.params.speed, !0, !0), a("autoplay")) : n.params.loop ? (n.loopFix(), t = n.slideNext(n.params.speed, !0, !0), a("autoplay")) : n.isEnd ? n.params.autoplay.stopOnLastSlide ? c() : (t = n.slideTo(0, n.params.speed, !0, !0), a("autoplay")) : (t = n.slideNext(n.params.speed, !0, !0), a("autoplay")), (n.params.cssMode && n.autoplay.running || !1 === t) && o()
            }), r)
        }

        function l() {
            return void 0 === e && !n.autoplay.running && (n.autoplay.running = !0, a("autoplayStart"), o(), !0)
        }

        function c() {
            return !!n.autoplay.running && void 0 !== e && (e && (clearTimeout(e), e = void 0), n.autoplay.running = !1, a("autoplayStop"), !0)
        }
        ...
        function d() {
            const t = r();
            "hidden" === t.visibilityState && n.autoplay.running && u(), "visible" === t.visibilityState && n.autoplay.paused && (o(), n.autoplay.paused = !1)
        }
        ...
        function h() {
            n.params.autoplay.disableOnInteraction ? c() : (a("autoplayPause"), u()), ["transitionend", "webkitTransitionEnd"].forEach((t => {
                n.$wrapperEl[0].removeEventListener(t, f)
            }))
        }
        ...
        n.autoplay = {
            ...
            n.params.autoplay.enabled && (l(), r().addEventListener("visibilitychange", d), n.params.autoplay.pauseOnMouseEnter && (n.$el.on("mouseenter", h), n.$el.on("mouseleave", m)))
        })), i("beforeTransitionStart", ((t, e, r) => {
            n.autoplay.running && (r || !n.params.autoplay.disableOnInteraction ? n.autoplay.pause(e) : c())
        })), i("sliderFirstMove", (() => {
            ...
            n.$el.off("mouseenter", h), n.$el.off("mouseleave", m), n.autoplay.running && c(), r().removeEventListener("visibilitychange", d)
        ...
        function a() {
            ...
            if (s = t.params.loop ? parseInt(c(t.clickedSlide).attr("data-swiper-slide-index"), 10) : n, e.params.loop) {
                ...
                const n = e.slides.eq(t).prevAll(`[data-swiper-slide-index="${s}"]`).eq(0).index(),
                    r = e.slides.eq(t).nextAll(`[data-swiper-slide-index="${s}"]`).eq(0).index();
        ...
        function l(t) {
            ...
            if (e.params.slidesPerView > 1 && !e.params.centeredSlides && (s = e.params.slidesPerView), e.params.thumbs.multipleActiveThumbs || (s = 1), s = Math.floor(s), n.slides.removeClass(i), n.params.loop || n.params.virtual && n.params.virtual.enabled)
                for (let t = 0; t < s; t += 1) n.$wrapperEl.children(`[data-swiper-slide-index="${e.realIndex+t}"]`).addClass(i);
            else
                for (let t = 0; t < s; t += 1) n.slides.eq(e.realIndex + t).addClass(i);
            const a = e.params.thumbs.autoScrollOffset,
                o = a && !n.params.loop;
            if (e.realIndex !== n.realIndex || o) {
                let s, i, l = n.activeIndex;
                if (n.params.loop) {
                    ...
                    s = void 0 === t ? r : void 0 === r ? t : r - l == l - t ? n.params.slidesPerGroup > 1 ? r : l : r - l < l - t ? r : t, i = e.activeIndex > e.previousIndex ? "next" : "prev"
                } else s = e.realIndex, i = s > e.previousIndex ? "next" : "prev";
                o && (s += "next" === i ? a : -1 * a), n.visibleSlidesIndexes && n.visibleSlidesIndexes.indexOf(s) < 0 && (n.params.centeredSlides ? s = s > l ? s - Math.floor(r / 2) + 1 : s + Math.floor(r / 2) - 1 : s > l && n.params.slidesPerGroup, n.slideTo(s, t ? 0 : void 0))
            }
        }
        e.thumbs = {
            swiper: null
                        ...
                        if (i.freeMode.momentum) {
                            if (c.velocities.length > 1) {
                                const t = c.velocities.pop(),
                                    ...
                                    s = t.time - n.time;
                                e.velocity = r / s, e.velocity /= 2, Math.abs(e.velocity) < i.freeMode.minimumVelocity && (e.velocity = 0), (s > 150 || d() - t.time > 300) && (e.velocity = 0)
                            } else e.velocity = 0;
                            ...
                            let m;
                            if (u < e.maxTranslate()) i.freeMode.momentumBounce ? (u + e.maxTranslate() < -h && (u = e.maxTranslate() - h), p = e.maxTranslate(), f = !0, c.allowMomentumBounce = !0) : u = e.maxTranslate(), i.loop && i.centeredSlides && (m = !0);
                            else if (u > e.minTranslate()) i.freeMode.momentumBounce ? (u - e.minTranslate() > h && (u = e.minTranslate() + h), p = e.minTranslate(), f = !0, c.allowMomentumBounce = !0) : u = e.minTranslate(), i.loop && i.centeredSlides && (m = !0);
                                ...
                                for (let e = 0; e < l.length; e += 1)
                                    if (l[e] > -u) {
                                        t = e;
                                        break
                                    } u = Math.abs(l[t] - u) < Math.abs(l[t - 1] - u) || "next" === e.swipeDirection ? l[t] : l[t - 1], u = -u
                            }
                            if (m && s("transitionEnd", (() => {
                                    e.loopFix()
                                })), 0 !== e.velocity) {
                                if (t = o ? Math.abs((-u - e.translate) / e.velocity) : Math.abs((u - e.translate) / e.velocity), i.freeMode.sticky) {
                                    const n = Math.abs((o ? -u : u) - e.translate),
                                        r = e.slidesSizesGrid[e.activeIndex];
                                    t = n < r ? i.speed : n < 2 * r ? 1.5 * i.speed : 2.5 * i.speed
                                }
                            } else if (i.freeMode.sticky) return void e.slideToClosest();
                            i.freeMode.momentumBounce && f ? (e.updateProgress(p), e.setTransition(t), e.setTranslate(u), e.transitionStart(!0, e.swipeDirection), e.animating = !0, a.transitionEnd((() => {
                                e && !e.destroyed && c.allowMomentumBounce && (r("momentumBounce"), e.setTransition(i.speed), setTimeout((() => {
                                    e.setTranslate(p), a.transitionEnd((() => {
                                        e && !e.destroyed && e.transitionEnd()
                                    }))
                                }), 0))
                            }))) : e.velocity ? (r("_freeModeNoMomentumRelease"), e.updateProgress(u), e.setTransition(t), e.setTranslate(u), e.transitionStart(!0, e.swipeDirection), e.animating || (e.animating = !0, a.transitionEnd((() => {
                                e && !e.destroyed && e.transitionEnd()
        ...
        i({
            ...
            initSlides: t => {
                ...
                n = e / a, r = Math.floor(t / a), e = Math.floor(t / a) === t / a ? t : Math.ceil(t / a) * a, "auto" !== i && "row" === o && (e = Math.max(e, i * a))
            },
            updateSlide: (t, i, a, o) => {
                const {
                    slidesPerGroup: l,
                ...
                if ("row" === p && l > 1) {
                    ...
                    h = Math.floor(r / s), f = r - h * s + n * l, d = f + h * e / u, i.css({
                        "-webkit-order": d,
                        order: d
                    })
                } else "column" === p ? (f = Math.floor(t / u), h = t - f * u, (f > r || f === r && h === u - 1) && (h += 1, h >= u && (h = 0, f += 1))) : (h = Math.floor(t / n), f = t - h * n);
            ...
            updateWrapperSize: (t, n, r) => {
                ...
                if (s.virtualSize = (t + i) * e, s.virtualSize = Math.ceil(s.virtualSize / l) - i, s.$wrapperEl.css({
                        [r("width")]: `${s.virtualSize+i}px`
                    }), a) {
                    n.splice(0, n.length);
                    const t = [];
                    for (let e = 0; e < n.length; e += 1) {
                        let r = n[e];
                        o && (r = Math.floor(r)), n[e] < s.virtualSize + n[0] && t.push(r)
                    }
                    n.push(...t)
                }
            }
        ...
        n({
            ...
            setTransition: t => {
                ...
                (n ? e.slides.find(n) : e.slides).transition(t), rt({
                    swiper: e,
                    duration: t,
                    transformEl: n,
                    allSlides: !0
        ...
        const s = (t, e, n) => {
            let r = n ? t.find(".swiper-slide-shadow-left") : t.find(".swiper-slide-shadow-top"),
                s = n ? t.find(".swiper-slide-shadow-right") : t.find(".swiper-slide-shadow-bottom");
            0 === r.length && (r = c(`<div class="swiper-slide-shadow-${n?"left":"top"}"></div>`), t.append(r)), 0 === s.length && (s = c(`<div class="swiper-slide-shadow-${n?"right":"bottom"}"></div>`), t.append(s)), r.length && (r[0].style.opacity = Math.max(-e, 0)), s.length && (s[0].style.opacity = Math.max(e, 0))
        };
        et({
            effect: "cube",
            swiper: e,
            ...
            setTranslate: () => {
                const {
                    ...
                    size: l,
                    browser: u
                } = e, p = e.params.cubeEffect, d = e.isHorizontal(), f = e.virtual && e.params.virtual.enabled;
                let h, m = 0;
                p.shadow && (d ? (h = n.find(".swiper-cube-shadow"), 0 === h.length && (h = c('<div class="swiper-cube-shadow"></div>'), n.append(h)), h.css({
                    height: `${i}px`
                ...
                for (let t = 0; t < r.length; t += 1) {
                    ...
                    let u = 0,
                        h = 0,
                        g = 0;
                    n % 4 == 0 ? (u = 4 * -a * l, g = 0) : (n - 1) % 4 == 0 ? (u = 0, g = 4 * -a * l) : (n - 2) % 4 == 0 ? (u = l + 4 * a * l, g = l) : (n - 3) % 4 == 0 && (u = -l, g = 3 * l + 4 * l * a), o && (u = -u), d || (h = u, u = 0);
                    const v = `rotateX(${d?0:-i}deg) rotateY(${d?i:0}deg) translate3d(${u}px, ${h}px, ${g}px)`;
                    c <= 1 && c > -1 && (m = 90 * n + 90 * c, o && (m = 90 * -n - 90 * c)), e.transform(v), p.slideShadows && s(e, c, d)
                }
                if (n.css({
                        "-webkit-transform-origin": `50% 50% -${l/2}px`,
                        "transform-origin": `50% 50% -${l/2}px`
                    }), p.shadow)
                    if (d) h.transform(`translate3d(0px, ${i/2+p.shadowOffset}px, ${-i/2}px) rotateX(90deg) rotateZ(0deg) scale(${p.shadowScale})`);
                    else {
                        const t = Math.abs(m) - 90 * Math.floor(Math.abs(m) / 90),
                            ...
                            r = p.shadowScale / e,
                            s = p.shadowOffset;
                        h.transform(`scale3d(${n}, 1, ${r}) translate3d(0px, ${a/2+s}px, ${-a/2/r}px) rotateX(-90deg)`)
                    } const g = u.isSafari || u.isWebView ? -l / 2 : 0;
                n.transform(`translate3d(0px,0,${g}px) rotateX(${e.isHorizontal()?0:m}deg) rotateY(${e.isHorizontal()?-m:0}deg)`), n[0].style.setProperty("--swiper-cube-translate-z", `${g}px`)
            },
            setTransition: t => {
                const {
                    $el: n,
        ...
        const s = (t, n, r) => {
            let s = e.isHorizontal() ? t.find(".swiper-slide-shadow-left") : t.find(".swiper-slide-shadow-top"),
                i = e.isHorizontal() ? t.find(".swiper-slide-shadow-right") : t.find(".swiper-slide-shadow-bottom");
            0 === s.length && (s = st(r, t, e.isHorizontal() ? "left" : "top")), 0 === i.length && (i = st(r, t, e.isHorizontal() ? "right" : "bottom")), s.length && (s[0].style.opacity = Math.max(-n, 0)), i.length && (i[0].style.opacity = Math.max(n, 0))
        };
        et({
            effect: "flip",
            swiper: e,
            ...
            setTranslate: () => {
                ...
                for (let i = 0; i < t.length; i += 1) {
                    ...
                    let c = -180 * o,
                        ...
                        d = 0;
                    e.isHorizontal() ? n && (c = -c) : (d = p, p = 0, u = -c, c = 0), a[0].style.zIndex = -Math.abs(Math.round(o)) + t.length, r.slideShadows && s(a, o, r);
            ...
            setTransition: t => {
                ...
                (n ? e.slides.find(n) : e.slides).transition(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(t), rt({
                    swiper: e,
                    duration: t,
                    transformEl: n
                })
            ...
            recreateShadows: () => {
                ...
                e.slides.each((n => {
                    const r = c(n);
                    let i = r[0].progress;
                    e.params.flipEffect.limitRotation && (i = Math.max(Math.min(n.progress, 1), -1)), s(r, i, t)
                }))
            },
        ...
        n({
            ...
            setTranslate: () => {
                const {
                    ...
                    slides: r,
                    slidesSizesGrid: s
                } = e, i = e.params.coverflowEffect, a = e.isHorizontal(), o = e.translate, l = a ? t / 2 - o : n / 2 - o, c = a ? i.rotate : -i.rotate, u = i.depth;
                for (let t = 0, e = r.length; t < e; t += 1) {
                    ...
                    let d = a ? c * p : 0,
                        ...
                        h = -u * Math.abs(p),
                        m = i.stretch;
                    "string" == typeof m && -1 !== m.indexOf("%") && (m = parseFloat(i.stretch) / 100 * n);
                    let g = a ? 0 : m * p,
                        v = a ? m * p : 0,
                        y = 1 - (1 - i.scale) * Math.abs(p);
                    Math.abs(v) < .001 && (v = 0), Math.abs(g) < .001 && (g = 0), Math.abs(h) < .001 && (h = 0), Math.abs(d) < .001 && (d = 0), Math.abs(f) < .001 && (f = 0), Math.abs(y) < .001 && (y = 0);
                    const b = `translate3d(${v}px,${g}px,${h}px)  rotateX(${f}deg) rotateY(${d}deg) scale(${y})`;
                    if (nt(i, e).transform(b), e[0].style.zIndex = 1 - Math.abs(Math.round(p)), i.slideShadows) {
                        ...
                        0 === t.length && (t = st(i, e, a ? "left" : "top")), 0 === n.length && (n = st(i, e, a ? "right" : "bottom")), t.length && (t[0].style.opacity = p > 0 ? p : 0), n.length && (n[0].style.opacity = -p > 0 ? -p : 0)
                    }
                }
            },
            setTransition: t => {
        ...
        et({
            ...
            setTranslate: () => {
                ...
                for (let n = 0; n < t.length; n += 1) {
                    const r = t.eq(n),
                        l = r[0].progress,
                        c = Math.min(Math.max(r[0].progress, -i.limitProgress), i.limitProgress);
                    let u = c;
                    o || (u = Math.min(Math.max(r[0].originalProgress, -i.limitProgress), i.limitProgress));
                    ...
                    c < 0 ? (m = i.next, h = !0) : c > 0 && (m = i.prev, h = !0), d.forEach(((t, e) => {
                        d[e] = `calc(${t}px + (${s(m.translate[e])} * ${Math.abs(c*a)}))`
                    })), f.forEach(((t, e) => {
            ...
            setTransition: t => {
                ...
                (n ? e.slides.find(n) : e.slides).transition(t).find(".swiper-slide-shadow").transition(t), rt({
                    swiper: e,
                    duration: t,
                    transformEl: n,
                    allSlides: !0
            ...
            setTranslate: () => {
                ...
                for (let o = 0; o < t.length; o += 1) {
                    ...
                    let m = 1,
                        ...
                        v = r.perSlideOffset - .75 * Math.abs(u);
                    const y = e.virtual && e.params.virtual.enabled ? e.virtual.from + o : o,
                        b = (y === n || y === n - 1) && u > 0 && u < 1 && (i || e.params.cssMode) && a < s,
                        _ = (y === n || y === n + 1) && u < 0 && u > -1 && (i || e.params.cssMode) && a > s;
                    if (b || _) {
                        const t = (1 - Math.abs((Math.abs(u) - .5) / .5)) ** .5;
                        g += -28 * u * t, m += -.5 * t, v += 96 * t, f = -25 * t * Math.abs(u) + "%"
                    }
                    if (d = u < 0 ? `calc(${d}px + (${v*Math.abs(u)}%))` : u > 0 ? `calc(${d}px + (-${v*Math.abs(u)}%))` : `${d}px`, !e.isHorizontal()) {
                        const t = f;
                        f = d, d = t
                    }
                    const w = u < 0 ? "" + (1 + (1 - m) * u) : "" + (1 - (1 - m) * u),
                        S = `\n        translate3d(${d}, ${f}, ${h}px)\n        rotateZ(${r.rotate?g:0}deg)\n        scale(${w})\n      `;
                    if (r.slideShadows) {
                        let t = l.find(".swiper-slide-shadow");
                        0 === t.length && (t = st(r, l)), t.length && (t[0].style.opacity = Math.min(Math.max((Math.abs(u) - .5) / .5, 0), 1))
                    }
                    l[0].style.zIndex = -Math.abs(Math.round(c)) + t.length, nt(r, l).transform(S)
                }
            },
            setTransition: t => {
                const {
...
function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.HSVideoBg = e() : t.HSVideoBg = e()
}(window, (function() {
    return d = {
    ...
    return function(t) {
        ...
        function P(t, e) {
            var n = t.collections.sourceLoadHandlers,
                ...
                a = t.props.sources;
            s[e] = document.createElement("img"), E(t, e, _), s[e].src = a[e], s[e].onload = n[e].handleImageLoad, T(t, e), i[e].appendChild(s[e])
        }
        ...
        function M(t, e) {
            var n = t.collections.sourceLoadHandlers,
                ...
                o = a.sources,
                l = a.videosPosters;
            s[e] = document.createElement("video"), E(t, e, _), s[e].src = o[e], s[e].onloadedmetadata = function(t) {
        ...
        function O(t, e) {
            var n = t.collections.sourceLoadHandlers,
                ...
                o = t.props.sources;
            i[e] = document.createElement("iframe"), E(t, e, "".concat(_, " ").concat(s, "youtube-iframe")), i[e].src = "https://www.youtube.com/embed/".concat(o[e].match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/)[2], "?enablejsapi=1"), i[e].allowFullscreen = !0, T(t, e), a[e].appendChild(i[e]), n[e].handleYoutubeLoad()
        }
        ...
        function A(t, e) {
            var n = t.collections.sourceLoadHandlers,
                ...
                i = r.sourceAnimationWrappers,
                a = t.props.sources;
            s[e] = a[e], E(t, e, "".concat(s[e].className, " ").concat(_)), i[e].appendChild(s[e]), n[e].handleCustomLoad()
        }
            ...
            r.className = "".concat(s, "nav"), n.appendChild(r),
                function(t, e) {
                    ...
                    n.className = "".concat(s, "toolbar"), e.appendChild(n),
                        ...
                        function(t, e) {
                            var n = N(e, "Close");
                            n.onclick = t.core.lightboxCloser.closeLightbox, V(n, "20px", "0 0 24 24", "M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z")
                        }(t, n)
        ...
        function z(t, e, n, r) {
            ...
            a.className = "".concat(f, " ").concat(f, "-").concat(n), a.title = "".concat(i, " slide"), a.onclick = e,
                function(t, e) {
                    var n = document.createElement("div");
                    n.className = "".concat(d, " ").concat(l), V(n, "20px", "0 0 20 20", e), t.appendChild(n)
                }(a, r), s.appendChild(a)
        }
            ...
            n = (e = t).core.classFacade, r = e.elements, n.removeFromEachElementClassIfContains = function(t, e) {
                ...
                function(t) {
                    ...
                    o.changeTo = function(t) {
                        ...
                        var e = d.current;
                        o.changeTo(t), a.removeFromEachElementClassIfContains("sourceMainWrappers", u), q(p[e], g), q(p[e], h), p[e].classList.add(m), q(p[t], g), q(p[t], m), p[t].classList.add(h), f(), r[t].zero(), setTimeout((function() {
        ...
        function J(t) {
            ...
            n.isInitialized = !0, n.scrollbarWidth = function(t) {
                ...
                function(t) {
                    for (var e = t.props.sources, n = t.resolve, r = n(S), s = n($), i = n(I, [r, s]), a = 0; a < e.length; a++)
        ...
        function Z(t) {
            ...
            i.open = function() {
                ...
                h.current = r, d.isInitialized ? s.dispatch("onShow") : J(t), u.updateStageIndexes(), l.displaySourcesWhichShouldBeDisplayed(), n.setSlideNumber(r + 1), document.body.appendChild(f.container), document.documentElement.classList.add(c), o.addRecompense(), a.attachListeners(), p.runActions(), e[h.current].zero(), s.dispatch("onOpen")
            }
        }
...
var countdown = function(t) {
        ...
        function h(t, e) {
            var n = t.getTime();
            return t.setMonth(t.getMonth() + e), Math.round((t.getTime() - n) / o)
        }

        function m(t) {
            var e = t.getTime(),
                n = new Date(e);
            return n.setMonth(t.getMonth() + 1), Math.round((n.getTime() - e) / o)
        }
        ...
        function k(t, e) {
            return C(t) + (1 === t ? v[e] : y[e])
        }

        function E() {}

        function T(t, e, n, r, o, d) {
            return t[n] >= 0 && (e += t[n], delete t[n]), (e /= o) + 1 <= 1 ? 0 : t[r] >= 0 ? (t[r] = +(t[r] + e).toFixed(d), function(t, e) {
                switch (e) {
                    case "seconds":
                    ...
                    case "minutes":
                        ...
                        t.hours++, t.minutes = 0;
                    case "hours":
                        if (t.hours !== a || isNaN(t.days)) return;
                        t.days++, t.hours = 0;
                    case "days":
                        if (7 !== t.days || isNaN(t.weeks)) return;
                        t.weeks++, t.days = 0;
                    case "weeks":
                        if (t.weeks !== m(t.refMonth) / 7 || isNaN(t.months)) return;
                        t.months++, t.weeks = 0;
                    case "months":
                        if (t.months !== l || isNaN(t.years)) return;
                        t.years++, t.months = 0;
                    case "years":
                        if (t.years !== c || isNaN(t.decades)) return;
                        t.decades++, t.years = 0;
                    case "decades":
                        if (t.decades !== u || isNaN(t.centuries)) return;
                        t.centuries++, t.decades = 0;
                    case "centuries":
                        if (t.centuries !== p || isNaN(t.millennia)) return;
        ...
        function P(t, e) {
            var n, l, d, f = T(t, 0, "milliseconds", "seconds", r, e);
            if (f && ((f = T(t, f, "seconds", "minutes", s, e)) && (f = T(t, f, "minutes", "hours", i, e)) && (f = T(t, f, "hours", "days", a, e)) && (f = T(t, f, "days", "weeks", 7, e)) && (f = T(t, f, "weeks", "months", m(t.refMonth) / 7, e)) && (f = T(t, f, "months", "years", (n = t.refMonth, l = n.getTime(), (d = new Date(l)).setFullYear(n.getFullYear() + 1), Math.round((d.getTime() - l) / o) / m(t.refMonth)), e)) && (f = T(t, f, "years", "decades", c, e)) && (f = T(t, f, "decades", "centuries", u, e)) && (f = T(t, f, "centuries", "millennia", p, e)))) throw new Error("Fractional unit overflow")
        }

        function M(t, o, m, g, v, y) {
            var b = new Date;
            if (t.start = o = o || b, t.end = m = m || b, t.units = g, t.value = m.getTime() - o.getTime(), t.value < 0) {
                var _ = m;
                m = o, o = _
            }
            t.refMonth = new Date(o.getFullYear(), o.getMonth(), 15, 12, 0, 0);
            try {
                t.millennia = 0, t.centuries = 0, t.decades = 0, t.years = m.getFullYear() - o.getFullYear(), t.months = m.getMonth() - o.getMonth(), t.weeks = 0, t.days = m.getDate() - o.getDate(), t.hours = m.getHours() - o.getHours(), t.minutes = m.getMinutes() - o.getMinutes(), t.seconds = m.getSeconds() - o.getSeconds(), t.milliseconds = m.getMilliseconds() - o.getMilliseconds(),
                    function(t) {
                        var e;
                        for (t.milliseconds < 0 ? (e = d(-t.milliseconds / r), t.seconds -= e, t.milliseconds += e * r) : t.milliseconds >= r && (t.seconds += f(t.milliseconds / r), t.milliseconds %= r), t.seconds < 0 ? (e = d(-t.seconds / s), t.minutes -= e, t.seconds += e * s) : t.seconds >= s && (t.minutes += f(t.seconds / s), t.seconds %= s), t.minutes < 0 ? (e = d(-t.minutes / i), t.hours -= e, t.minutes += e * i) : t.minutes >= i && (t.hours += f(t.minutes / i), t.minutes %= i), t.hours < 0 ? (e = d(-t.hours / a), t.days -= e, t.hours += e * a) : t.hours >= a && (t.days += f(t.hours / a), t.hours %= a); t.days < 0;) t.months--, t.days += h(t.refMonth, 1);
                        t.days >= 7 && (t.weeks += f(t.days / 7), t.days %= 7), t.months < 0 ? (e = d(-t.months / l), t.years -= e, t.months += e * l) : t.months >= l && (t.years += f(t.months / l), t.months %= l), t.years >= c && (t.decades += f(t.years / c), t.years %= c, t.decades >= u && (t.centuries += f(t.decades / u), t.decades %= u, t.centuries >= p && (t.millennia += f(t.centuries / p), t.centuries %= p)))
                    }(t),
                    function(t, o, d, m) {
                        var g = 0;
                        !(o & n) || g >= d ? (t.centuries += t.millennia * p, delete t.millennia) : t.millennia && g++, !(512 & o) || g >= d ? (t.decades += t.centuries * u, delete t.centuries) : t.centuries && g++, !(256 & o) || g >= d ? (t.years += t.decades * c, delete t.decades) : t.decades && g++, !(o & e) || g >= d ? (t.months += t.years * l, delete t.years) : t.years && g++, !(64 & o) || g >= d ? (t.months && (t.days += h(t.refMonth, t.months)), delete t.months, t.days >= 7 && (t.weeks += f(t.days / 7), t.days %= 7)) : t.months && g++, !(32 & o) || g >= d ? (t.days += 7 * t.weeks, delete t.weeks) : t.weeks && g++, !(16 & o) || g >= d ? (t.hours += t.days * a, delete t.days) : t.days && g++, !(8 & o) || g >= d ? (t.minutes += t.hours * i, delete t.hours) : t.hours && g++, !(4 & o) || g >= d ? (t.seconds += t.minutes * s, delete t.minutes) : t.minutes && g++, !(2 & o) || g >= d ? (t.milliseconds += t.seconds * r, delete t.seconds) : t.seconds && g++, 1 & o && !(g >= d) || P(t, m)
                    }(t, g, v, y)
            } finally {
                delete t.refMonth
            }
        ...
        function O(t, e, n, s, i) {
            var a;
            n = +n || 222, s = s > 0 ? s : NaN, i = i > 0 ? i < 20 ? Math.round(i) : 20 : 0;
            var o = null;
            "function" == typeof t ? (a = t, t = null) : t instanceof Date || (null !== t && isFinite(t) ? t = new Date(+t) : ("object" == typeof o && (o = t), t = null));
            var l = null;
            if ("function" == typeof e ? (a = e, e = null) : e instanceof Date || (null !== e && isFinite(e) ? e = new Date(+e) : ("object" == typeof e && (l = e), e = null)), o && (t = g(o, e)), l && (e = g(l, t)), !t && !e) return new E;
            if (!a) return M(new E, t, e, n, s, i);
            var c, u = function(t) {
                    return 1 & t ? 33.333333333333336 : 2 & t ? r : 4 & t ? 6e4 : 8 & t ? 36e5 : 16 & t ? 864e5 : 6048e5
                }(n),
                p = function() {
                    a(M(new E, t, e, n, s, i), c)
                };
        ...
        E.prototype.toString = function(t) {
            ...
            var r = b + e.pop();
            return e.join(_) + r
        }, E.prototype.toHTML = function(t, e) {
            t = t || "span";
            var n = x(this),
                r = n.length;
            if (!r) return (e = e || w) ? "<" + t + ">" + e + "</" + t + ">" : e;
            ...
            var e = [],
                n = t.millennia;
            return n && e.push(S(n, 10)), (n = t.centuries) && e.push(S(n, 9)), (n = t.decades) && e.push(S(n, 8)), (n = t.years) && e.push(S(n, 7)), (n = t.months) && e.push(S(n, 6)), (n = t.weeks) && e.push(S(n, 5)), (n = t.days) && e.push(S(n, 4)), (n = t.hours) && e.push(S(n, 3)), (n = t.minutes) && e.push(S(n, 2)), (n = t.seconds) && e.push(S(n, 1)), (n = t.milliseconds) && e.push(S(n, 0)), e
        }, O.MILLISECONDS = 1, O.SECONDS = 2, O.MINUTES = 4, O.HOURS = 8, O.DAYS = 16, O.WEEKS = 32, O.MONTHS = 64, O.YEARS = e, O.DECADES = 256, O.CENTURIES = 512, O.MILLENNIA = n, O.DEFAULTS = 222, O.ALL = 2047;
        var A = O.setFormat = function(t) {
                if (t) {
                    if ("singular" in t || "plural" in t) {
                        ...
                        var n = t.plural || [];
                        n.split && (n = n.split("|"));
                        for (var r = 0; r <= 10; r++) v[r] = e[r] || v[r], y[r] = n[r] || y[r]
                    }
                    "string" == typeof t.last && (b = t.last), "string" == typeof t.delim && (_ = t.delim), "string" == typeof t.empty && (w = t.empty), "function" == typeof t.formatNumber && (C = t.formatNumber), "function" == typeof t.formatter && (S = t.formatter)
                }
            },
            j = O.resetFormat = function() {
                v = " millisecond| second| minute| hour| day| week| month| year| decade| century| millennium".split("|"), y = " milliseconds| seconds| minutes| hours| days| weeks| months| years| decades| centuries| millennia".split("|"), b = " and ", _ = ", ", w = "", C = function(t) {
                    return t
                }, S = k
            };
        return O.setLabels = function(t, e, n, r, s, i, a) {
            A({
                singular: t,
                plural: e,
                last: n,
        ...
        }, O.resetLabels = j, j(), t && t.exports ? t.exports = O : "function" == typeof window.define && void 0 !== window.define.amd && window.define("countdown", [], (function() {
            return O
        })), O
    }(module),
    List;
    ...
    var t = {
            ...
            "./src/index.js": function(t, e, n) {
                ...
                t.exports = function(t, e, d) {
                    ...
                    f = {
                        start: function() {
                            h.listClass = "list", h.searchClass = "search", h.sortClass = "sort", h.page = 1e4, h.i = 1, h.items = [], h.visibleItems = [], h.matchingItems = [], h.searched = !1, h.filtered = !1, h.searchColumns = void 0, h.searchDelay = 0, h.handlers = {
                                updated: []
                            }, h.valueNames = [], h.utils = {
                                getByClass: s,
                                extend: i,
                                indexOf: a,
                                events: o,
                                ...
                                getAttribute: u,
                                toArray: p
                            }, h.utils.extend(h, e), h.listContainer = "string" == typeof t ? document.getElementById(t) : t, h.listContainer && (h.list = s(h.listContainer, h.listClass, !0), h.parse = n("./src/parse.js")(h), h.templater = n("./src/templater.js")(h), h.search = n("./src/search.js")(h), h.filter = n("./src/filter.js")(h), h.sort = n("./src/sort.js")(h), h.fuzzySearch = n("./src/fuzzy-search.js")(h, e.fuzzySearch), this.handlers(), this.items(), this.pagination(), h.update())
                        },
                        handlers: function() {
                            for (var t in h.handlers) h[t] && h.handlers.hasOwnProperty(t) && h.on(t, h[t])
                        },
                        items: function() {
                        ...
                        h.items = [], h.visibleItems = [], h.matchingItems = [], h.searched = !1, h.filtered = !1, h.parse(h.list)
                    }, this.toJSON = function() {
                        for (var t = [], e = 0, n = h.items.length; e < n; e++) t.push(h.items[e].values());
                        return t
                        ...
                        if (0 !== t.length) {
                            if (!e) {
                                ...
                                for (var s = 0, i = t.length; s < i; s++) {
                                    var a;
                                    r = h.items.length > h.page, a = new m(t[s], void 0, r), h.items.push(a), n.push(a)
                                }
                                return h.update(), n
                            }
                            g(t.slice(0), e)
                        ...
                        for (var r = 0, s = 0, i = h.items.length; s < i; s++) h.items[s].values()[t] == e && (h.templater.remove(h.items[s], n), h.items.splice(s, 1), i--, s--, r++);
                        return h.update(), r
                        ...
                        var t = h.items,
                            e = t.length;
                        h.visibleItems = [], h.matchingItems = [], h.templater.clear();
                        for (var n = 0; n < e; n++) t[n].matching() && h.matchingItems.length + 1 >= h.i && h.visibleItems.length < h.page ? (t[n].show(), h.visibleItems.push(t[n]), h.matchingItems.push(t[n])) : t[n].matching() ? (h.matchingItems.push(t[n]), t[n].hide()) : t[n].hide();
                ...
                t.exports = function(t) {
                    var e = !1,
                        n = function(n, s) {
                            ...
                            for (var m = 1; m <= u; m++) {
                                var g = p === m ? "active" : "";
                                a.number(m, f, h, p, d) ? (i = n.add({
                                    page: m,
                                    dotted: !1
                                })[0], g && r(i.elm).add(g), i.elm.firstChild.setAttribute("data-i", m), i.elm.firstChild.setAttribute("data-page", c)) : a.dotted(n, m, f, h, p, d, n.size()) && (i = n.add({
                                    page: "...",
                                    dotted: !0
                                ...
                                if (l.found = !1, s.length) {
                                    for (var c = 0, u = s.length; c < u; c++) {
                                        for (var p = !1, d = 0, f = e.length; d < f; d++) {
                                            var h = l.values(),
                                                m = e[d];
                                            if (h.hasOwnProperty(m) && void 0 !== h[m] && null !== h[m] && -1 !== ("string" != typeof h[m] ? h[m].toString() : h[m]).toLowerCase().indexOf(s[c])) {
                                                p = !0;
                                                break
                                            }
                                        }
                ...
                t.exports = function(t, e, n) {
                    ...
                    for (var h, m = e.length + t.length, g = 0; g < e.length; g++) {
                        ...
                        for (var _ = y; _ >= v; _--) {
                            ...
                            if (b[_] = 0 === g ? (b[_ + 1] << 1 | 1) & w : (b[_ + 1] << 1 | 1) & w | (h[_ + 1] | h[_]) << 1 | 1 | h[_ + 1], b[_] & f) {
                                var S = l(g, _ - 1);
                                if (S <= c) {
                                ...
                                for (var b = s, _ = i; b < e.length; _ += e[b].length, ++b) {
                                    ...
                                    if (!(w instanceof l)) {
                                        if (m && b != e.length - 1) {
                                            ...
                                            for (var S = T.index + (h ? T[1].length : 0), C = T.index + T[0].length, x = b, k = _, E = e.length; E > x && (C > k || !e[x].type && !e[x - 1].greedy); ++x) S >= (k += e[x].length) && (++b, _ = k);
                                        ...
                                        if (T) {
                                            ...
                                            if (A.push(j), O && A.push(O), Array.prototype.splice.apply(e, A), 1 != P && n.matchGrammar(t, e, r, b, _, !0, c), a) break
                                        } else if (a) break
                                    }
                                }
                            }
