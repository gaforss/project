...
// Define route for pairing wines with food
router.post('/wines/pair-my-food', wineController.pairWinesWithFood);
...
// Route to get wine distribution by country
router.get('/country-distribution', wineController.getWineCountryDistribution);
...
router.post('/:id/consume', isAuthenticated, wineController.markAsConsumed);
router.get('/history', wineController.getHistoryData);
...
// Route to get cellar data
router.get('/cellar-data', wineController.getCellarData);
router.put('/update-position', wineController.updateWinePosition);
